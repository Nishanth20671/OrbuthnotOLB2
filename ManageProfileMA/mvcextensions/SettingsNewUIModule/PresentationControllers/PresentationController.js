...
this.securityQuestionsPayload  = "";
 ...
 this.features=[];
     ...
     */
    SettingsNew_PresentationController.prototype.editPhoneNumber = function(id, viewModel,isMFARequired) {
       ...
       if( CommonUtilities.getSCAType() ==0)
        applicationManager.getUserPreferencesManager().updateUserProfileDetails(params, this.editPhoneNumberSuccess.bind(this), this.editPhoneNumberFailure.bind(this));
          ...
          params.stepUp = isMFARequired;
          let action = SCAConfiguration.UPDATE_PHONE_NUMBER;
          SCAConfiguration.sendSCANotificationRequest(params, action, this.editPhoneNumberSuccess.bind(this),this.editPhoneNumberFailure.bind(this));
        }
     ...
     */
    SettingsNew_PresentationController.prototype.savePhoneNumber = function(viewModel,isMFARequired) {
    ...
    SettingsNew_PresentationController.prototype.fetchUserSuccess = function(requiredView, alertsError,response) {
        ...
        if (requiredView === "ContactNumbers") {
          ...
          this.statusRequest();
          (response[0].Addresses !== null) ? scope.statusCall["addressList"]=response[0].Addresses : scope.statusCall["addressList"] = [];
          }
     ...
     */
    SettingsNew_PresentationController.prototype.saveEmail = function(context,isMFARequired) {
    ...
    /**
     * Method used to show the status request.
     */
    SettingsNew_PresentationController.prototype.statusRequest = function() {
      var params = {
        "subType":"UpdatePrimaryAddress",
        "type":"ManageAddress"
        };
      applicationManager.getUserPreferencesManager().getRequestStatus(params,this.statusRequestSuccessCallBack.bind(this), this.statusFailureCallBack.bind(this));
     },
     SettingsNew_PresentationController.prototype.statusRequestSuccessCallBack = function(response){
      scope.statusCall["statusMessage"] = response;
      applicationManager.getNavigationManager().navigateTo({
          "appName": "ManageProfileMA",
          "friendlyName": "frmAddressSettings"
      });
      applicationManager.getNavigationManager().updateForm(scope.statusCall, "frmAddressSettings");
    };
    SettingsNew_PresentationController.prototype.statusFailureCallBack = function(errorMessage){
      var viewProperties = {
        isLoading: false,
        addNewAddress: {
            serverError: errorMessage
    ...
    applicationManager.getNavigationManager().updateForm(viewProperties, "frmChangeOfAcknowledgement");
  ...
  /**
     ...
     */
    SettingsNew_PresentationController.prototype.editEmail = function(Context,isMFARequired) {
        ...
        SCAConfiguration.sendSCANotificationRequest(params, action, this.editEmailSuccess.bind(this), this.editEmailFailure.bind(this));
      }
    };
  ...
  /**
    ...
    SettingsNew_PresentationController.prototype.AddAddressViewModel = function(countries, states, cities) {
        var countryNew = [];
        countryNew.push(["1", kony.i18n.getLocalizedString("i18n.ProfileManagement.selectCountry")]);
        var stateNew = [];
        stateNew.push(["lbl1", kony.i18n.getLocalizedString("i18n.ProfileManagement.selectState")]);
        return {
            serverError: null,
    ...
    SettingsNew_PresentationController.prototype.saveAddress = function(addressObj) {
        ...
        scope.getPrimaryAddressPayLoad["Documents"]=addresses.Documents;
        scope.getPrimaryAddressPayLoad["UpdatePrimaryAddress"]=addresses.UpdatePrimaryAddress;
        var params = {
            "Documents":addresses.Documents,
            "UpdatePrimaryAddress": addresses.UpdatePrimaryAddress,
            "userName": applicationManager.getUserPreferencesManager().getCurrentUserName(),
            "modifiedByName": applicationManager.getUserPreferencesManager().getCurrentUserName()
        };
        // params.UpdatePrimaryAddress=[];
        // params.UpdatePrimaryAddress.push(addresses.UpdatePrimaryAddress);
        // addresses = JSON.stringify(addresses);
        // addresses = addresses.replace(/"/g, "'");
        applicationManager.getUserPreferencesManager().getUpdatedAddressDetails(params, this.getUpdateAddressSuccess.bind(this), this.getUpdateAddressFailure.bind(this));
      }
      else {
        this.showProgressBar();
        var addresses = [{
            Addr_type: addressObj[0].Addr_type,
            addrLine1: addressObj[0].addrLine1,
            addrLine2: addressObj[0].addrLine2,
            City_id: addressObj[0].citySelected,
            countryCode: addressObj[0].countrySelected,
            ZipCode: addressObj[0].zipcode,
            isPrimary: (addressObj[0].isPrimary === true) ? "1" : "0",
            Region_id: addressObj[0].stateSelected
        }];
        addresses = JSON.stringify(addresses);
        addresses = addresses.replace(/"/g, "'");
        var params = {
      ...
      SettingsNew_PresentationController.prototype.getUpdateAddressSuccess = function(response){
        //the below line should be changes according to the response that will be shared by srms

        response[0]=scope.getPrimaryAddressPayLoad;
        applicationManager.getNavigationManager().navigateTo({"appName" : "ManageProfileMA", "friendlyName" : "frmChangeOfAddressAcknowledgement"});
        applicationManager.getNavigationManager().updateForm({
          updatedAddress : response
      }, "frmChangeOfAddressAcknowledgement");
      };
      SettingsNew_PresentationController.prototype.getUpdateAddressFailure = function(errorMessage){
       ...
       applicationManager.getNavigationManager().updateForm(viewProperties, kony.application.getCurrentForm().id);
      };
    /**
    ...
    SettingsNew_PresentationController.prototype.getEditAddressViewSuccess = function(address, syncResponseObject) {
        if (syncResponseObject.isAllSuccess()) {
            ...
            viewModel.countrySelected = address.Country_id ? address.Country_id : address.CountryCode;
            viewModel.stateSelected = address.Region_id;
            viewModel.citySelected = address.City_id;
            viewModel.customerID = address.customerID;
            viewModel.customerName = address.customerName;
  ...
  SettingsNew_PresentationController.prototype.updateUsername = function(userName) {
   ...
   SettingsNew_PresentationController.prototype.updateUsernameSuccess = function(response) {
    ...
    SettingsNew_PresentationController.prototype.updateAddress = function(context) {
        var addresses = [{
                "Addr_type": context[0].Addr_type,
                "isPrimary": (context[0].isPrimary === true) ? "1" : "0",
                "addrLine1": context[0].addrLine1,
                "addrLine2": context[0].addrLine2,
                "ZipCode": context[0].ZipCode,
                "City_id": context[0].City_id,
                "Addr_id": context.addressId,
                "Region_id": context[0].Region_id,
                "countryCode": context[0].countrySelected 
            }],
            addresses = JSON.stringify(addresses);
        addresses = addresses.replace(/"/g, "'");
        var params = {
  ...
  /**
    ...
    SettingsNew_PresentationController.prototype.fetchAlertsCategory = function(entryPoint,accountID) {
        ...
        if(entryPoint=="profileSettings"){
          ...
          applicationManager.getNavigationManager().navigateTo({"appName" : "ManageProfileMA", "friendlyName" : "frmProfile"});
          this.showProgressBar("frmProfile");
        } else if(entryPoint=="deviceManagement"){
          this.showDeviceManagementScreen();
          applicationManager.getNavigationManager().navigateTo({"appName" : "ManageProfileMA", "friendlyName" : "frmDeviceManagementHID"});
          //this.showProgressBar("frmDeviceManagementHID");
    ...
    SettingsNew_PresentationController.prototype.showDeviceManagementScreen = function() {
      applicationManager.getNavigationManager().navigateTo({"appName" : "ManageProfileMA", "friendlyName" : "SettingsHIDUIModule/frmDeviceManagementHID"});
      applicationManager.getNavigationManager().updateForm({
        "isLoading": false,
        "showRegisteredDevices": true
      },'frmDeviceManagementHID');
    };
...
SettingsNew_PresentationController.prototype.sortSegmentDataforAccountLevel = function(segmentData, sectionIndex, imgWidget, sortKey){
  ...
  SettingsNew_PresentationController.prototype.getUsernameRulesAndPoliciesFailure = function() {
   ...
   SettingsNew_PresentationController.prototype.showBankingAccess = function() {
     kony.application.showLoadingScreen();
     applicationManager.getSettingsManager().fetchLegalEntities(this.showBankingAccessSuccess.bind(this),
                                                                    this.showBankingAccessFailure.bind(this));
 };
  
     SettingsNew_PresentationController.prototype.showBankingAccessSuccess = function(response) {
       applicationManager.getNavigationManager().navigateTo("frmeBankingAccess");
       applicationManager.getNavigationManager().updateForm({
            "eBankingAccessLanding": response
        }, 'frmeBankingAccess');
 };
  
     SettingsNew_PresentationController.prototype.showBankingAccessFailure = function(error) {
  ...
  SettingsNew_PresentationController.prototype.showEntityPreferences = function () {
    applicationManager.getNavigationManager().navigateTo(
      {
        "appName": "ManageProfileMA",
        "friendlyName": "SettingsNewUIModule/frmSettingsEntityPreferences"
      }
    );
    applicationManager.getNavigationManager().updateForm({ "isLoading": true });
    applicationManager.getNavigationManager().updateForm({ "isLoading": false });
   ...
   */
  SettingsNew_PresentationController.prototype.getTncContent = function (type, legalEntityId) {
    ...
    } else if (type === OLBConstants.TNC_FLOW_TYPES.Login_TnC) {
      codeTnC = OLBConstants.TNC_FLOW_TYPES.Login_TnC;
    }
    var param = {
   ...
   */
  SettingsNew_PresentationController.prototype.disableEBankingAccess = function(entities,flowtype){
    ...
    userManager.updateUserStatus(params,this.disableEBankingAccessSuccess.bind(this,flowtype),this.disableEBankingAccessError);
   };
    /**
  ...
  SettingsNew_PresentationController.prototype.disableEBankingAccessSuccess = function(type,response){
    if (response && response.MFAAttributes && response.MFAAttributes.isMFARequired) {
      var mfaJSON = {
        "serviceName": applicationManager.getMFAManager().getServiceId(),
...
/**
  ...
  SettingsNew_PresentationController.prototype.createTnC = function (inputParams) {
    params = {
      "languageCode": kony.i18n.getCurrentLocale().replace("_", "-"),
      "legalEntityId": inputParams.selectedLegalEntityId
    };
    if (inputParams.flowType === OLBConstants.TNC_FLOW_TYPES.Login_TnC) {
      applicationManager.getTermsAndConditionManager().createTermsAndConditionsLogin(params, this.onSuccessCreateTnC.bind(this, inputParams), this.onFailureCreateTnC.bind(this, inputParams));
    }
  };

  SettingsNew_PresentationController.prototype.onSuccessCreateTnC = function (inputParams, response) {
    if (inputParams.flowType === OLBConstants.TNC_FLOW_TYPES.Login_TnC) {
      this.updateDefaultEntity(inputParams.selectedLegalEntityId);
    }
  };

  SettingsNew_PresentationController.prototype.onFailureCreateTnC = function (inputParams, response) {
    if (inputParams.flowType === OLBConstants.TNC_FLOW_TYPES.Login_TnC) {
      applicationManager.getNavigationManager().updateForm({
        error: response
      }, "frmSettingsEntityPreferences");
  ...
  SettingsNew_PresentationController.prototype.updateDefaultEntity = function (selectedLegalEntityId) {
    var userId = applicationManager.getUserPreferencesManager().getUserId();
  ...
  SettingsNew_PresentationController.prototype.updateDefaultEntitySuccess = function (selectedLegalEntityId, response) {
    applicationManager.getUserPreferencesManager().saveDefaultLegalEntity(selectedLegalEntityId);
    applicationManager.getNavigationManager().updateForm({
      updateDefaultEntityResponse: response
    }, "frmSettingsEntityPreferences");
  };

  SettingsNew_PresentationController.prototype.updateDefaultEntityFailure = function (response) {
    CommonUtilities.showServerDownScreen();
  };
