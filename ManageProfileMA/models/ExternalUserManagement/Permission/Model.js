...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "Permission", "objectService" : "ExternalUserManagement"};
    ...
    function Permission(defaultValues) {
        var privateState = {};
        context["field"] = "accountHolder";
        context["metadata"] = (objectMetadata ? objectMetadata["accountHolder"] : null);
    ...
    BaseModel.isParentOf(Permission);

    //Create new class level validator object
    BaseModel.Validator.call(Permission);

    var registerValidatorBackup = Permission.registerValidator;

    Permission.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(Permission.isValid(this, propName, val)) {
    ...
    //For Operation 'verifyAccountPermissions' with service id 'verifyAccountPermissions8457'
     Permission.verifyAccountPermissions = function(params, onCompletion){
        return Permission.customVerb('verifyAccountPermissions', params, onCompletion);
     };

    var relations = [];

    Permission.relations = relations;

    Permission.prototype.isValid = function() {
        return Permission.isValid(this);
    };

    Permission.prototype.objModelName = "Permission";
    Permission.prototype.objServiceName = "ExternalUserManagement";
     ...
     */
    Permission.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ExternalUserManagement", "Permission", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    Permission.clone = function(objectToClone) {
        var clonedObj = new Permission();
