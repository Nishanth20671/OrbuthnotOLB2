...
define([], function() {
    ...
    var setterFunctions = {
        ...
        UpdatePrimaryAddress: function(val, state) {
            context["field"] = "UpdatePrimaryAddress";
            context["metadata"] = (objectMetadata ? objectMetadata["UpdatePrimaryAddress"] : null);
            state['UpdatePrimaryAddress'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        ...
        serviceReqResponse: function(val, state) {
            context["field"] = "serviceReqResponse";
            context["metadata"] = (objectMetadata ? objectMetadata["serviceReqResponse"] : null);
            state['serviceReqResponse'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        default_from_account_qr: function(val, state) {
            context["field"] = "default_from_account_qr";
            context["metadata"] = (objectMetadata ? objectMetadata["default_from_account_qr"] : null);
            state['default_from_account_qr'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    };
    ...
    function ExternalUsers(defaultValues) {
        ...
        context["field"] = "UpdatePrimaryAddress";
        context["metadata"] = (objectMetadata ? objectMetadata["UpdatePrimaryAddress"] : null);
        privateState.UpdatePrimaryAddress = defaultValues ?
            (defaultValues["UpdatePrimaryAddress"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["UpdatePrimaryAddress"], context) :
                null) :
            null;
        ...
        context["field"] = "serviceReqResponse";
        context["metadata"] = (objectMetadata ? objectMetadata["serviceReqResponse"] : null);
        privateState.serviceReqResponse = defaultValues ?
            (defaultValues["serviceReqResponse"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["serviceReqResponse"], context) :
                null) :
            null;

        context["field"] = "default_from_account_qr";
        context["metadata"] = (objectMetadata ? objectMetadata["default_from_account_qr"] : null);
        privateState.default_from_account_qr = defaultValues ?
            (defaultValues["default_from_account_qr"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["default_from_account_qr"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "UpdatePrimaryAddress": {
                get: function() {
                    context["field"] = "UpdatePrimaryAddress";
                    context["metadata"] = (objectMetadata ? objectMetadata["UpdatePrimaryAddress"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.UpdatePrimaryAddress, context);
                },
                set: function(val) {
                    setterFunctions['UpdatePrimaryAddress'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "Documents": {
            ...
            "serviceReqResponse": {
                get: function() {
                    context["field"] = "serviceReqResponse";
                    context["metadata"] = (objectMetadata ? objectMetadata["serviceReqResponse"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.serviceReqResponse, context);
                },
                set: function(val) {
                    setterFunctions['serviceReqResponse'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "default_from_account_qr": {
                get: function() {
                    context["field"] = "default_from_account_qr";
                    context["metadata"] = (objectMetadata ? objectMetadata["default_from_account_qr"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.default_from_account_qr, context);
                },
                set: function(val) {
                    setterFunctions['default_from_account_qr'].call(this, val, privateState);
                },
                enumerable: true,
            },
        });
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.UpdatePrimaryAddress = value ? (value["UpdatePrimaryAddress"] ? value["UpdatePrimaryAddress"] : null) : null;
            ...
            privateState.serviceReqResponse = value ? (value["serviceReqResponse"] ? value["serviceReqResponse"] : null) : null;
            privateState.default_from_account_qr = value ? (value["default_from_account_qr"] ? value["default_from_account_qr"] : null) : null;
        };
    }
    ...
    //For Operation 'UpdateAddressWithProof' with service id 'UpdateAddressWithDocsOperation1973'
     ExternalUsers.UpdateAddressWithProof = function(params, onCompletion){
        return ExternalUsers.customVerb('UpdateAddressWithProof', params, onCompletion);
     };
    ...
    //For Operation 'geRequestStatus' with service id 'GetOrderDetailsOperation6962'
     ExternalUsers.geRequestStatus = function(params, onCompletion){
        return ExternalUsers.customVerb('geRequestStatus', params, onCompletion);
     };

    //For Operation 'getCustomerIdentifiers' with service id 'getCustomerIdentifiers2800'
     ExternalUsers.getCustomerIdentifiers = function(params, onCompletion){
        return ExternalUsers.customVerb('getCustomerIdentifiers', params, onCompletion);
     };
    ...
    ExternalUsers.prototype.objServiceName = "ExternalUserManagement";
