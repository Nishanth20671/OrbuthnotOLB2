...
define([], function() {
    ...
    var setterFunctions = {
        ...
        legalEntityList: function(val, state) {
            context["field"] = "legalEntityList";
            context["metadata"] = (objectMetadata ? objectMetadata["legalEntityList"] : null);
            state['legalEntityList'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    };
    ...
    function ExternalUsers_2(defaultValues) {
        ...
        context["field"] = "legalEntityList";
        context["metadata"] = (objectMetadata ? objectMetadata["legalEntityList"] : null);
        privateState.legalEntityList = defaultValues ?
            (defaultValues["legalEntityList"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["legalEntityList"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "legalEntityList": {
                get: function() {
                    context["field"] = "legalEntityList";
                    context["metadata"] = (objectMetadata ? objectMetadata["legalEntityList"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.legalEntityList, context);
                },
                set: function(val) {
                    setterFunctions['legalEntityList'].call(this, val, privateState);
                },
                enumerable: true,
            },
        });
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.legalEntityList = value ? (value["legalEntityList"] ? value["legalEntityList"] : null) : null;
        };
    }
    ...
    //For Operation 'updateEmployment' with service id 'updateEmployment2689'
     ExternalUsers_2.updateEmployment = function(params, onCompletion){
        return ExternalUsers_2.customVerb('updateEmployment', params, onCompletion);
     };
    ...
    //For Operation 'updateSourceOfFunds' with service id 'UpdateSourceOfFundsOperation2074'
     ExternalUsers_2.updateSourceOfFunds = function(params, onCompletion){
        return ExternalUsers_2.customVerb('updateSourceOfFunds', params, onCompletion);
     };
    ...
    //For Operation 'getPartyAndDueDiligenceDetails' with service id 'getPartyAndDueDiligenceDetails6494'
     ExternalUsers_2.getPartyAndDueDiligenceDetails = function(params, onCompletion){
        return ExternalUsers_2.customVerb('getPartyAndDueDiligenceDetails', params, onCompletion);
     };
    ...
    //For Operation 'updateAssetLiabilities' with service id 'UpdateAssetLiabilitiesOperation9773'
     ExternalUsers_2.updateAssetLiabilities = function(params, onCompletion){
        return ExternalUsers_2.customVerb('updateAssetLiabilities', params, onCompletion);
     };
    ...
    ExternalUsers_2.prototype.objServiceName = "ExternalUserManagement";
