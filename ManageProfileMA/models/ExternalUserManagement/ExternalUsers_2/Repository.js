define([], function(){
	...
	ExternalUsers_2Repository.prototype.updateEmployment = function(params, onCompletion){
		return ExternalUsers_2Repository.prototype.customVerb('updateEmployment', params, onCompletion);
	};
	...
	ExternalUsers_2Repository.prototype.updateSourceOfFunds = function(params, onCompletion){
		return ExternalUsers_2Repository.prototype.customVerb('updateSourceOfFunds', params, onCompletion);
	};
	...
	ExternalUsers_2Repository.prototype.getPartyAndDueDiligenceDetails = function(params, onCompletion){
		return ExternalUsers_2Repository.prototype.customVerb('getPartyAndDueDiligenceDetails', params, onCompletion);
	};
	...
	ExternalUsers_2Repository.prototype.updateAssetLiabilities = function(params, onCompletion){
		return ExternalUsers_2Repository.prototype.customVerb('updateAssetLiabilities', params, onCompletion);
	};
