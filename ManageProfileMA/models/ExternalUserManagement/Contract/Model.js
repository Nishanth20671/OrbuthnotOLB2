...
define([], function() {
    ...
    var setterFunctions = {
        ...
        accountLevelPermissions1: function(val, state) {
            context["field"] = "accountLevelPermissions1";
            context["metadata"] = (objectMetadata ? objectMetadata["accountLevelPermissions1"] : null);
            state['accountLevelPermissions1'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        globalLevelPermissions1: function(val, state) {
            context["field"] = "globalLevelPermissions1";
            context["metadata"] = (objectMetadata ? objectMetadata["globalLevelPermissions1"] : null);
            state['globalLevelPermissions1'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        isDefaultActionsEnabled: function(val, state) {
            context["field"] = "isDefaultActionsEnabled";
            context["metadata"] = (objectMetadata ? objectMetadata["isDefaultActionsEnabled"] : null);
            state['isDefaultActionsEnabled'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        productIdList: function(val, state) {
            context["field"] = "productIdList";
            context["metadata"] = (objectMetadata ? objectMetadata["productIdList"] : null);
            state['productIdList'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        ...
        transactionLimits1: function(val, state) {
            context["field"] = "transactionLimits1";
            context["metadata"] = (objectMetadata ? objectMetadata["transactionLimits1"] : null);
            state['transactionLimits1'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        ...
        legalEntityId: function(val, state) {
            context["field"] = "legalEntityId";
            context["metadata"] = (objectMetadata ? objectMetadata["legalEntityId"] : null);
            state['legalEntityId'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    };
    ...
    function Contract(defaultValues) {
        ...
        context["field"] = "accountLevelPermissions1";
        context["metadata"] = (objectMetadata ? objectMetadata["accountLevelPermissions1"] : null);
        privateState.accountLevelPermissions1 = defaultValues ?
            (defaultValues["accountLevelPermissions1"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["accountLevelPermissions1"], context) :
                null) :
            null;

        context["field"] = "globalLevelPermissions1";
        context["metadata"] = (objectMetadata ? objectMetadata["globalLevelPermissions1"] : null);
        privateState.globalLevelPermissions1 = defaultValues ?
            (defaultValues["globalLevelPermissions1"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["globalLevelPermissions1"], context) :
                null) :
            null;

        context["field"] = "isDefaultActionsEnabled";
        context["metadata"] = (objectMetadata ? objectMetadata["isDefaultActionsEnabled"] : null);
        privateState.isDefaultActionsEnabled = defaultValues ?
            (defaultValues["isDefaultActionsEnabled"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isDefaultActionsEnabled"], context) :
                null) :
            null;

        context["field"] = "productIdList";
        context["metadata"] = (objectMetadata ? objectMetadata["productIdList"] : null);
        privateState.productIdList = defaultValues ?
            (defaultValues["productIdList"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["productIdList"], context) :
                null) :
            null;
        ...
        context["field"] = "transactionLimits1";
        context["metadata"] = (objectMetadata ? objectMetadata["transactionLimits1"] : null);
        privateState.transactionLimits1 = defaultValues ?
            (defaultValues["transactionLimits1"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["transactionLimits1"], context) :
                null) :
            null;
        ...
        context["field"] = "legalEntityId";
        context["metadata"] = (objectMetadata ? objectMetadata["legalEntityId"] : null);
        privateState.legalEntityId = defaultValues ?
            (defaultValues["legalEntityId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["legalEntityId"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "accountLevelPermissions1": {
                get: function() {
                    context["field"] = "accountLevelPermissions1";
                    context["metadata"] = (objectMetadata ? objectMetadata["accountLevelPermissions1"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.accountLevelPermissions1, context);
                },
                set: function(val) {
                    setterFunctions['accountLevelPermissions1'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "globalLevelPermissions1": {
                get: function() {
                    context["field"] = "globalLevelPermissions1";
                    context["metadata"] = (objectMetadata ? objectMetadata["globalLevelPermissions1"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.globalLevelPermissions1, context);
                },
                set: function(val) {
                    setterFunctions['globalLevelPermissions1'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "isDefaultActionsEnabled": {
                get: function() {
                    context["field"] = "isDefaultActionsEnabled";
                    context["metadata"] = (objectMetadata ? objectMetadata["isDefaultActionsEnabled"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.isDefaultActionsEnabled, context);
                },
                set: function(val) {
                    setterFunctions['isDefaultActionsEnabled'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "productIdList": {
                get: function() {
                    context["field"] = "productIdList";
                    context["metadata"] = (objectMetadata ? objectMetadata["productIdList"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.productIdList, context);
                },
                set: function(val) {
                    setterFunctions['productIdList'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "transactionLimits": {
            ...
            "transactionLimits1": {
                get: function() {
                    context["field"] = "transactionLimits1";
                    context["metadata"] = (objectMetadata ? objectMetadata["transactionLimits1"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.transactionLimits1, context);
                },
                set: function(val) {
                    setterFunctions['transactionLimits1'].call(this, val, privateState);
                },
                enumerable: true,
            },
            ...
            "legalEntityId": {
                get: function() {
                    context["field"] = "legalEntityId";
                    context["metadata"] = (objectMetadata ? objectMetadata["legalEntityId"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.legalEntityId, context);
                },
                set: function(val) {
                    setterFunctions['legalEntityId'].call(this, val, privateState);
                },
                enumerable: true,
            },
        });
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.accountLevelPermissions1 = value ? (value["accountLevelPermissions1"] ? value["accountLevelPermissions1"] : null) : null;
            privateState.globalLevelPermissions1 = value ? (value["globalLevelPermissions1"] ? value["globalLevelPermissions1"] : null) : null;
            privateState.isDefaultActionsEnabled = value ? (value["isDefaultActionsEnabled"] ? value["isDefaultActionsEnabled"] : null) : null;
            privateState.productIdList = value ? (value["productIdList"] ? value["productIdList"] : null) : null;
            privateState.transactionLimits = value ? (value["transactionLimits"] ? value["transactionLimits"] : null) : null;
            privateState.transactionLimits1 = value ? (value["transactionLimits1"] ? value["transactionLimits1"] : null) : null;
            ...
            privateState.legalEntityId = value ? (value["legalEntityId"] ? value["legalEntityId"] : null) : null;
        };
    }
    ...
    //For Operation 'getProductPermissions' with service id 'getProductLevelPermissions7723'
     Contract.getProductPermissions = function(params, onCompletion){
        return Contract.customVerb('getProductPermissions', params, onCompletion);
     };
    ...
    //For Operation 'getServiceDefinitionProductIdPermissions' with service id 'ServiceDefinitionProductIdPermissions1669'
     Contract.getServiceDefinitionProductIdPermissions = function(params, onCompletion){
        return Contract.customVerb('getServiceDefinitionProductIdPermissions', params, onCompletion);
     };
    ...
    //For Operation 'getCoreCustomerProductRolesFeatureActionLimits' with service id 'GetCoreCustomerProductRolesFeatureActionLimits1430'
     Contract.getCoreCustomerProductRolesFeatureActionLimits = function(params, onCompletion){
        return Contract.customVerb('getCoreCustomerProductRolesFeatureActionLimits', params, onCompletion);
     };
    ...
    //For Operation 'addNewFeaturesTOContractFromSD' with service id 'AddNewFeaturesTOContractFromSD4265'
     Contract.addNewFeaturesTOContractFromSD = function(params, onCompletion){
        return Contract.customVerb('addNewFeaturesTOContractFromSD', params, onCompletion);
     };
    ...
    //For Operation 'DBXCustomerCommunicationDetails' with service id 'DBXCustomerCommunicationDetails6747'
     Contract.DBXCustomerCommunicationDetails = function(params, onCompletion){
        return Contract.customVerb('DBXCustomerCommunicationDetails', params, onCompletion);
     };
    ...
    //For Operation 'getCoreCustomerDetails' with service id 'CoreCustomerDetailsGet2107'
     Contract.getCoreCustomerDetails = function(params, onCompletion){
        return Contract.customVerb('getCoreCustomerDetails', params, onCompletion);
     };
    ...
    Contract.prototype.objServiceName = "ExternalUserManagement";
