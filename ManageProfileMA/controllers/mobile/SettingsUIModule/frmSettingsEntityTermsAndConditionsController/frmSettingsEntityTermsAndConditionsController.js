define(['CampaignUtility', 'CommonUtilities'], function (CampaignUtility, CommonUtilities) {
  return {
    ...
    onAcceptOfTermsAndConditions: function () {
      let navManager = applicationManager.getNavigationManager();
      let termsAndConditionsData = navManager.getCustomInfo("frmSettingsEntityTermsAndConditions");
      let request = {
      ...
      settingsUIModule.presentationController.updateTermsAndConditions(request);
    },
