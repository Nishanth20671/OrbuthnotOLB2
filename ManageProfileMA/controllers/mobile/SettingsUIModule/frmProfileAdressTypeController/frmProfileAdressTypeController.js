define({
  ...
  processAndNavigate : function (context) {
    var scope = this;
    scope.selectedprofileAddressType = (scope.view.segAddressType.selectedRowItems && scope.view.segAddressType.selectedRowItems.length>1) ? scope.view.segAddressType.selectedRowItems[1] :-1;
    if(scope.view.segAddressType.selectedRowItems && scope.view.segAddressType.selectedRowItems.length>0){
    var data = {
      "addressType" : scope.view.segAddressType.selectedRowItems[0].btnOption["value"],
      "addressTypeForDisplay": scope.view.segAddressType.selectedRowItems[0].btnOption["text"]
    };
