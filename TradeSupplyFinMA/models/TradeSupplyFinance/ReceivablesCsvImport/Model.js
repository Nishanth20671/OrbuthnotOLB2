...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ReceivablesCsvImport", "objectService" : "TradeSupplyFinance"};
    ...
    var setterFunctions = {
        ...
        bills: function(val, state) {
            context["field"] = "bills";
            context["metadata"] = (objectMetadata ? objectMetadata["bills"] : null);
            state['bills'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        ...
        fileReferene: function(val, state) {
            context["field"] = "fileReferene";
            context["metadata"] = (objectMetadata ? objectMetadata["fileReferene"] : null);
            state['fileReferene'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        ...
        billReferences: function(val, state) {
            context["field"] = "billReferences";
            context["metadata"] = (objectMetadata ? objectMetadata["billReferences"] : null);
            state['billReferences'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        batchReferences: function(val, state) {
            context["field"] = "batchReferences";
            context["metadata"] = (objectMetadata ? objectMetadata["batchReferences"] : null);
            state['batchReferences'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        counts: function(val, state) {
            context["field"] = "counts";
            context["metadata"] = (objectMetadata ? objectMetadata["counts"] : null);
            state['counts'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        fileDate: function(val, state) {
            context["field"] = "fileDate";
            context["metadata"] = (objectMetadata ? objectMetadata["fileDate"] : null);
            state['fileDate'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    ...
    function ReceivablesCsvImport(defaultValues) {
        var privateState = {};
        context["field"] = "filterByValue";
        context["metadata"] = (objectMetadata ? objectMetadata["filterByValue"] : null);
        ...
        context["field"] = "bills";
        context["metadata"] = (objectMetadata ? objectMetadata["bills"] : null);
        privateState.bills = defaultValues ?
            (defaultValues["bills"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["bills"], context) :
                null) :
            null;
        ...
        context["field"] = "fileReferene";
        context["metadata"] = (objectMetadata ? objectMetadata["fileReferene"] : null);
        privateState.fileReferene = defaultValues ?
            (defaultValues["fileReferene"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["fileReferene"], context) :
                null) :
            null;
        ...
        context["field"] = "billReferences";
        context["metadata"] = (objectMetadata ? objectMetadata["billReferences"] : null);
        privateState.billReferences = defaultValues ?
            (defaultValues["billReferences"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["billReferences"], context) :
                null) :
            null;

        context["field"] = "batchReferences";
        context["metadata"] = (objectMetadata ? objectMetadata["batchReferences"] : null);
        privateState.batchReferences = defaultValues ?
            (defaultValues["batchReferences"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["batchReferences"], context) :
                null) :
            null;

        context["field"] = "counts";
        context["metadata"] = (objectMetadata ? objectMetadata["counts"] : null);
        privateState.counts = defaultValues ?
            (defaultValues["counts"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["counts"], context) :
                null) :
            null;

        context["field"] = "fileDate";
        context["metadata"] = (objectMetadata ? objectMetadata["fileDate"] : null);
        privateState.fileDate = defaultValues ?
            (defaultValues["fileDate"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["fileDate"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "bills": {
                get: function() {
                    context["field"] = "bills";
                    context["metadata"] = (objectMetadata ? objectMetadata["bills"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.bills, context);
                },
                set: function(val) {
                    setterFunctions['bills'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "timeValue": {
            ...
            "fileReferene": {
                get: function() {
                    context["field"] = "fileReferene";
                    context["metadata"] = (objectMetadata ? objectMetadata["fileReferene"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.fileReferene, context);
                },
                set: function(val) {
                    setterFunctions['fileReferene'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "billReference": {
            ...
            "billReferences": {
                get: function() {
                    context["field"] = "billReferences";
                    context["metadata"] = (objectMetadata ? objectMetadata["billReferences"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.billReferences, context);
                },
                set: function(val) {
                    setterFunctions['billReferences'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "batchReferences": {
                get: function() {
                    context["field"] = "batchReferences";
                    context["metadata"] = (objectMetadata ? objectMetadata["batchReferences"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.batchReferences, context);
                },
                set: function(val) {
                    setterFunctions['batchReferences'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "counts": {
                get: function() {
                    context["field"] = "counts";
                    context["metadata"] = (objectMetadata ? objectMetadata["counts"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.counts, context);
                },
                set: function(val) {
                    setterFunctions['counts'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "fileDate": {
                get: function() {
                    context["field"] = "fileDate";
                    context["metadata"] = (objectMetadata ? objectMetadata["fileDate"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.fileDate, context);
                },
                set: function(val) {
                    setterFunctions['fileDate'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "fileType": {
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.bills = value ? (value["bills"] ? value["bills"] : null) : null;
            ...
            privateState.fileReferene = value ? (value["fileReferene"] ? value["fileReferene"] : null) : null;
            ...
            privateState.billReferences = value ? (value["billReferences"] ? value["billReferences"] : null) : null;
            privateState.batchReferences = value ? (value["batchReferences"] ? value["batchReferences"] : null) : null;
            privateState.counts = value ? (value["counts"] ? value["counts"] : null) : null;
            privateState.fileDate = value ? (value["fileDate"] ? value["fileDate"] : null) : null;
    ...
    BaseModel.isParentOf(ReceivablesCsvImport);

    //Create new class level validator object
    BaseModel.Validator.call(ReceivablesCsvImport);

    var registerValidatorBackup = ReceivablesCsvImport.registerValidator;

    ReceivablesCsvImport.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(ReceivablesCsvImport.isValid(this, propName, val)) {
    ...
    //For Operation 'submitCsvImport' with service id 'SubmitCsvImportedBills2798'
     ReceivablesCsvImport.submitCsvImport = function(params, onCompletion){
        return ReceivablesCsvImport.customVerb('submitCsvImport', params, onCompletion);
     };

    //For Operation 'createBills' with service id 'CreateBillsCsvImport6762'
     ReceivablesCsvImport.createBills = function(params, onCompletion){
        return ReceivablesCsvImport.customVerb('createBills', params, onCompletion);
     };

    //For Operation 'deleteImportedBills' with service id 'DeleteCsvImportedBills9618'
     ReceivablesCsvImport.deleteImportedBills = function(params, onCompletion){
        return ReceivablesCsvImport.customVerb('deleteImportedBills', params, onCompletion);
     };

    //For Operation 'getCsvImports' with service id 'GetCsvImports9336'
     ReceivablesCsvImport.getCsvImports = function(params, onCompletion){
        return ReceivablesCsvImport.customVerb('getCsvImports', params, onCompletion);
     };

    //For Operation 'getCsvImportById' with service id 'GetCsvImportById2125'
     ReceivablesCsvImport.getCsvImportById = function(params, onCompletion){
        return ReceivablesCsvImport.customVerb('getCsvImportById', params, onCompletion);
     };

    var relations = [];

    ReceivablesCsvImport.relations = relations;

    ReceivablesCsvImport.prototype.isValid = function() {
        return ReceivablesCsvImport.isValid(this);
    };

    ReceivablesCsvImport.prototype.objModelName = "ReceivablesCsvImport";
    ReceivablesCsvImport.prototype.objServiceName = "TradeSupplyFinance";
     ...
     */
    ReceivablesCsvImport.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("TradeSupplyFinance", "ReceivablesCsvImport", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    ReceivablesCsvImport.clone = function(objectToClone) {
        var clonedObj = new ReceivablesCsvImport();
        clonedObj.fromJsonInternal(objectToClone.toJsonInternal());
        return clonedObj;
    };

    return ReceivablesCsvImport;
});