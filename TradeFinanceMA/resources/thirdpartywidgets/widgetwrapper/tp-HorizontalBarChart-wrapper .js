HorizontalBarChart = {
    initializeWidget: function (e, t) {
        (e.innerHTML = `<div id="${t.chartProperties.widgetId}"></div>`), google.charts.load("45", { packages: ["corechart"] }), HorizontalBarChart.setDataForStackedBarChart(t);
        var a = t.chartData;
        HorizontalBarChart.modelChange(t, "Refresh", a);
    },
    modelChange: function (e, t, a) {
        HorizontalBarChart.setDataForStackedBarChart(e);
    },
        ...
        for (i in t) {
            function r() {
                var t = google.visualization.arrayToDataTable(a),
                    r = e.chartProperties,
                    o = new google.visualization.BarChart(document.getElementById(r.widgetId));
                google.visualization.events.addListener(o, "onmouseover", function () {
                    ...
                    google.visualization.events.addListener(o, "onmouseout", function () {
                        document.getElementById(r.widgetId).style.cursor = "default";
