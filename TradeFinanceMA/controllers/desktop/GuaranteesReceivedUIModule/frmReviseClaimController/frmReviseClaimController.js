define(["FormControllerUtility", "CommonUtilities", "OLBConstants"], function (FormControllerUtility, CommonUtilities, OLBConstants) {
  ...
  return {
    ...
    postShow: function () {
      ...
      this.view.lblHeading.text = kony.i18n.getLocalizedString("i18n.TradeFinance.receivedGtAndSblcClaimRevise");
      this.view.lblDiscrepancy.text = `${kony.i18n.getLocalizedString('i18n.TradeFinance.ResponsetoDiscrepancies')} (1st)`;
      this.view.flxClaimSummary.setVisibility(false);
      this.view.flxGuaranteeSummary.setVisibility(false);
      this.view.flxReviseClaim.setVisibility(true);
      this.view.flxReviewReviseClaimDetails.setVisibility(false);
    ...
    initFormActions: function () {
      ...
      this.view.btnViewGtAndSblcDetails.onClick = () => scope.view.flxGuaranteeDetailsPopup.setVisibility(true);
      this.view.btnClose.onClick = this.togglePopup.bind(this, true);
      ...
      this.view.lblDiscrepancyIcon.onTouchEnd = this.toggleDropdown.bind(this, this.view.flxResponseToDiscrepanciesDetails, this.view.lblDiscrepancyIcon);
      this.view.lblNewClaimDetailsIcon.onTouchEnd = this.toggleDropdown.bind(this, this.view.flxClaimDetails, this.view.lblNewClaimDetailsIcon);
      ...
      this.view.btnBack.onClick = () => scope.presenter.showView({ form: 'frmViewClaimDetails' });
      this.view.btnSubmit.onClick = () => {
        ...
        scope.view.lblHeading.text = kony.i18n.getLocalizedString("i18n.TradeFinance.receivedGtAndSblcClaimReviewAndSubmit");
        scope.view.flxClaimSummary.setVisibility(true);
        scope.view.flxGuaranteeSummary.setVisibility(true);
        scope.view.flxReviseClaim.setVisibility(false);
        scope.view.flxReviewReviseClaimDetails.setVisibility(true);
        scope.populateClaimDetails();
      };
      this.view.btnReviewClose.onClick = this.togglePopup.bind(this, true);
      this.view.btnReviewBack.onClick = () => {
        scope.view.lblHeading.text = kony.i18n.getLocalizedString("i18n.TradeFinance.receivedGtAndSblcClaimRevise");
        scope.view.flxClaimSummary.setVisibility(false);
        scope.view.flxGuaranteeSummary.setVisibility(false);
        scope.view.flxReviseClaim.setVisibility(true);
        scope.view.flxReviewReviseClaimDetails.setVisibility(false);
      };
      ...
      this.view.switchToggle.onTouchEnd = this.toggleClaimFields;
    ...
    togglePopup: function (visibility, flow) {
      if (visibility) {
        ...
        this.view.Popup.lblPopupMessage.text = kony.i18n.getLocalizedString("i18n.savingsPot.closePotConfirmationMsg1") + "?";
        this.view.Popup.btnNo.onClick = this.togglePopup.bind(this, false);
        this.view.Popup.btnYes.onClick = () => this.presenter.showGuaranteesReceivedScreen({ context: 'viewAllInitiatedClaims' });
        switch (flow) {
          case 'uploadDocument':
    ...
    resetForm: function () {
      ...
      this.view.flxClaimAmount.setVisibility(false);
      this.view.flxCreditAndChargesAccount.setVisibility(false);
      this.view.flxDemandType.setVisibility(false);
    ...
    getFormData: function () {
      let formData = {
        ...
        'physicalDocuments': '',
        'forwardDocuments': this.view.lblCheckbox.text === this.presenter.resourcesConstants.fontIcons.checkboxSelected ? 'Selected' : 'Unselected',
    ...
    */
    ...
    populateGuaranteeSummaryDetails: function () {
      ...
      this.view.lblValue1.text = data.beneficiaryName || data.applicantName || NA;
      this.view.lblValue2.text = data.guaranteeSrmsId || NA;
      this.view.lblValue3.text = data.productType || NA;
      this.view.lblValue4.text = data.lcType || NA;
      ...
      this.view.flxPhysicalDocuments.setVisibility(data.productType !== 'Guarantee');
      this.view.tbxCurrency.text = data.currency || '';
      this.view.lblGuaranteeDetailsHeading.text = `${kony.i18n.getLocalizedString('i18n.TradeFinance.GuaranteeAndStandbyLC')} - ${data.guaranteeSrmsId}`;
    },
    ...
    populateClaimSummaryDetails: function () {
      ...
      this.view.lblClaimValue1.text = data.status || NA;
    ...
    toggleClaimFields: function () {
      let flag = (!this.view.flxClaimAmount.isVisible) ? true : false
      this.view.flxUploadDocuments.top = flag ? "30dp" : "20dp"
      this.view.flxClaimAmount.setVisibility(flag);
      this.view.flxCreditAndChargesAccount.setVisibility(flag);
      this.view.flxDemandType.setVisibility(flag);
      this.view.flxNewExtensionDate.setVisibility(flag && this.view.lblDemandTypeOptionIcon2.text === this.presenter.resourcesConstants.fontIcons.radioSelected);
      this.view.flxOtherDetails.setVisibility(flag);
    }
  };
});