define(['CommonUtilities'], function (CommonUtilities) {
    ...
    return {
        ...
        appendSwiftKeysAndValues: function () {
            ...
            try {
                ...
                swiftTagsWithDbValues.map((item) => {
                    ...
                    if (existingValue && !scope.isNullOrUndefined(pritDataObj[item.tagNameInDB])) {
                ...
                if (lblCount === 1) {
                    ...
                    scope.view.lblRowSequence1SwiftKey.text = kony.i18n.getLocalizedString("i18n.common.unavailable");
        ...
        seti18nKeys: function () {
            var scope = this;
            try {
                scope.view.lblIncomingMessageTagDetails.text = kony.i18n.getLocalizedString("i18n.TradeFinance.incomingMessageTagDetails");
                scope.view.lblIssuedGuaranteeStandbyLC.text = kony.i18n.getLocalizedString("i18n.TradeFinance.issuedGuaranteeAndStandbyLC");
                scope.view.lblMessageKey.text = kony.i18n.getLocalizedString("i18n.TradeFinance.messageKey");
                scope.view.lblMessageTypeKey.text = kony.i18n.getLocalizedString("i18n.ExportLC.MessageType");
                scope.view.lblReceiverDateAndTimeKey.text = kony.i18n.getLocalizedString("i18n.TradeFinance.receiverDateandTime");
                scope.view.lblSenderKey.text = kony.i18n.getLocalizedString("i18n.TradeFinance.sender");
                scope.view.lblReceiverKey.text = kony.i18n.getLocalizedString("i18n.TradeFinance.receiver");
                scope.view.lblMessage.text = kony.i18n.getLocalizedString("kony.tab.common.Message");
            }
            catch (err) {
                var errorObj =
                {
