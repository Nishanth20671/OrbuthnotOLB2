define({
  ...
  this.view.btnSTDownload.onClick = this.enableDownloadPopup;
    this.preShow();
...
//       }
  ...
  onclickdownload:function(){
    ...
    var navMan = applicationManager.getNavigationManager();
    var transactionDetail = navMan.getCustomInfo("frmMMTransactionDetails");
    var transactionData = {};
    
    transactionData.Id = transactionDetail.Id === undefined ? "":transactionDetail.Id;
    transactionData.amount = transactionDetail.amount === undefined ? "":transactionDetail.amount;
    transactionData.checkNumber = transactionDetail.checkNumber === undefined ? "":transactionDetail.checkNumber;
    transactionData.description = transactionDetail.description === undefined ? "":transactionDetail.description;
    transactionData.fromAccountBalance = transactionDetail.fromAccountBalance === undefined ? "":transactionDetail.fromAccountBalance;
    transactionData.fromAccountNumber = transactionDetail.fromAccountNumber === undefined ? "":transactionDetail.fromAccountNumber;
    transactionData.isScheduled = transactionDetail.isScheduled === undefined ? "":transactionDetail.isScheduled;
    transactionData.payeeCurrency = transactionDetail.payeeCurrency === undefined ? "":transactionDetail.payeeCurrency;
    transactionData.postedDate = transactionDetail.postedDate === undefined ? "":transactionDetail.postedDate;
    transactionData.scheduledDate = transactionDetail.scheduledDate === undefined ? "":transactionDetail.scheduledDate;
    transactionData.statusDescription = transactionDetail.statusDescription === undefined ? "":transactionDetail.statusDescription;
    transactionData.transactionCurrency = transactionDetail.transactionCurrency === undefined ? "":transactionDetail.transactionCurrency;
    transactionData.transactionDate = transactionDetail.transactionDate === undefined ? "":transactionDetail.transactionDate;
    transactionData.transactionId = transactionDetail.transactionId === undefined ? "":transactionDetail.transactionId;
    transactionData.transactionType = transactionDetail.transactionType === undefined ? "":transactionDetail.transactionType;
    transactionData.transactionsNotes = transactionDetail.transactionsNotes === undefined ? "":transactionDetail.transactionsNotes;
