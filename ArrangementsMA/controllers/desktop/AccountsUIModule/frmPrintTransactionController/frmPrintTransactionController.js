    ...
    return {
        ...
        updateFormUI: function(viewModel) {
           var scope = this;
            ...
            if (viewModel.printData) {

                viewModel = viewModel.printData;

                scope.setDataForTransaction(viewModel.transactions);

            scope.setAccountDetailsInformation(viewModel.accountDetailsModel, viewModel.accountDisplayName);
        ...
        setAccountDetailsInformation: function(accountDetailsModel, accountDisplayName) {
            ...
            if (accountDetailsModel.accountType === applicationManager.getTypeManager().getAccountTypeBackendValue(OLBConstants.ACCOUNT_TYPE.LOAN)) {
                ...
                CommonUtilities.setText(this.view.keyValueCurrentBalance.lblValue, CommonUtilities.formatCurrencyWithCommas(accountDetailsModel.originalAmount, false, accountDetailsModel.currencyCode), accessibilityConfig);
                CommonUtilities.setText(this.view.keyValueCurrentBalance.lblKey, kony.i18n.getLocalizedString('i18n.accountDetail.principalAmount'), accessibilityConfig);
                CommonUtilities.setText(this.view.keyValuePendingDeposits.lblValue, CommonUtilities.formatCurrencyWithCommas(accountDetailsModel.currentDue, false, accountDetailsModel.currencyCode), accessibilityConfig);
                CommonUtilities.setText(this.view.keyValuePendingDeposits.lblKey, kony.i18n.getLocalizedString('i18n.accountDetail.currentDueAmount'), accessibilityConfig);
                this.view.keyValuePendingWithdrawal.setVisibility(false);
				//CommonUtilities.setText(this.view.keyValuePendingWithdrawal.lblValue, CommonUtilities.formatCurrencyWithCommas(accountDetailsModel.currentDue, false, accountDetailsModel.currencyCode), accessibilityConfig);
        ...
        setDataForTransaction: function(transactions) {
            ...
            if (firstTable) {
                ...
                var accessibilityConfig = CommonUtilities.getaccessibilityConfig();
                if (header === "Posted") {transactionType = kony.i18n.getLocalizedString("i18n.accounts.posted");}
                if (header === "Pending") {transactionType = kony.i18n.getLocalizedString("i18n.Search.Pending");}
                CommonUtilities.setText(this.view.lblPendingTransactions, transactionType, accessibilityConfig);
//                CommonUtilities.setText(this.view.lblPendingTransactions, firstTable[0].lblTransactionHeader.text, accessibilityConfig);
   ...
   //             CommonUtilities.setText(this.view.CopylblPendingTransactions0a979ad50321149, secondTable[0].lblTransactionHeader.text, accessibilityConfig);
              CommonUtilities.setText(this.view.CopylblPendingTransactions0a979ad50321149, transactionType, accessibilityConfig); 
