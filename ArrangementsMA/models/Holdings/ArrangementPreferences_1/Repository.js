define([], function(){
	...
	ArrangementPreferences_1Repository.prototype.updateQRPaymentPreferredAccount = function(params, onCompletion){
		return ArrangementPreferences_1Repository.prototype.customVerb('updateQRPaymentPreferredAccount', params, onCompletion);
	};

	//For Operation 'activateQRPayment' with service id 'ActivateQRPaymentForUser4890'
	ArrangementPreferences_1Repository.prototype.activateQRPayment = function(params, onCompletion){
		return ArrangementPreferences_1Repository.prototype.customVerb('activateQRPayment', params, onCompletion);
	};
