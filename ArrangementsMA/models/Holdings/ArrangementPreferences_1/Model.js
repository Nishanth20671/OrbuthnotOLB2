...
define([], function() {
    ...
    var setterFunctions = {
        ...
        isQRPaymentActivated: function(val, state) {
            context["field"] = "isQRPaymentActivated";
            context["metadata"] = (objectMetadata ? objectMetadata["isQRPaymentActivated"] : null);
            state['isQRPaymentActivated'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    ...
    function ArrangementPreferences_1(defaultValues) {
        ...
        context["field"] = "isQRPaymentActivated";
        context["metadata"] = (objectMetadata ? objectMetadata["isQRPaymentActivated"] : null);
        privateState.isQRPaymentActivated = defaultValues ?
            (defaultValues["isQRPaymentActivated"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isQRPaymentActivated"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "isQRPaymentActivated": {
                get: function() {
                    context["field"] = "isQRPaymentActivated";
                    context["metadata"] = (objectMetadata ? objectMetadata["isQRPaymentActivated"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.isQRPaymentActivated, context);
                },
                set: function(val) {
                    setterFunctions['isQRPaymentActivated'].call(this, val, privateState);
                },
                enumerable: true,
            },
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.isQRPaymentActivated = value ? (value["isQRPaymentActivated"] ? value["isQRPaymentActivated"] : null) : null;
    ...
    //For Operation 'updateQRPaymentPreferredAccount' with service id 'UpdatePreferredQRPaymentAccount7129'
     ArrangementPreferences_1.updateQRPaymentPreferredAccount = function(params, onCompletion){
        return ArrangementPreferences_1.customVerb('updateQRPaymentPreferredAccount', params, onCompletion);
     };

    //For Operation 'activateQRPayment' with service id 'ActivateQRPaymentForUser4890'
     ArrangementPreferences_1.activateQRPayment = function(params, onCompletion){
        return ArrangementPreferences_1.customVerb('activateQRPayment', params, onCompletion);
     };
