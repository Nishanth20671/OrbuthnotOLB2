...
define([], function() {
    ...
    var setterFunctions = {
        ...
        currentMaturityDate: function(val, state) {
            context["field"] = "currentMaturityDate";
            context["metadata"] = (objectMetadata ? objectMetadata["currentMaturityDate"] : null);
            state['currentMaturityDate'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        ...
        loansDetails: function(val, state) {
            context["field"] = "loansDetails";
            context["metadata"] = (objectMetadata ? objectMetadata["loansDetails"] : null);
            state['loansDetails'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    ...
    function Mortgage(defaultValues) {
        ...
        context["field"] = "currentMaturityDate";
        context["metadata"] = (objectMetadata ? objectMetadata["currentMaturityDate"] : null);
        privateState.currentMaturityDate = defaultValues ?
            (defaultValues["currentMaturityDate"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["currentMaturityDate"], context) :
                null) :
            null;
        ...
        context["field"] = "loansDetails";
        context["metadata"] = (objectMetadata ? objectMetadata["loansDetails"] : null);
        privateState.loansDetails = defaultValues ?
            (defaultValues["loansDetails"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["loansDetails"], context) :
                null) :
            null;
        ...
        Object.defineProperties(this, {
            ...
            "currentMaturityDate": {
                get: function() {
                    context["field"] = "currentMaturityDate";
                    context["metadata"] = (objectMetadata ? objectMetadata["currentMaturityDate"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.currentMaturityDate, context);
                },
                set: function(val) {
                    setterFunctions['currentMaturityDate'].call(this, val, privateState);
                },
                enumerable: true,
            },
            ...
            "loansDetails": {
                get: function() {
                    context["field"] = "loansDetails";
                    context["metadata"] = (objectMetadata ? objectMetadata["loansDetails"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.loansDetails, context);
                },
                set: function(val) {
                    setterFunctions['loansDetails'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "errmsg": {
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.currentMaturityDate = value ? (value["currentMaturityDate"] ? value["currentMaturityDate"] : null) : null;
            privateState.supportingDocumentIds = value ? (value["supportingDocumentIds"] ? value["supportingDocumentIds"] : null) : null;
            privateState.loansDetails = value ? (value["loansDetails"] ? value["loansDetails"] : null) : null;
