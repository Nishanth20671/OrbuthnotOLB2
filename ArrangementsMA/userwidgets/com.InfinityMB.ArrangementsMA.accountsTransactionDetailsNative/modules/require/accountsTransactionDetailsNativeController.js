        ...
        preShow: function() {
            ...
            try {
                ...
                scopeObj.view.btnContextualAction1.onClick = function() {
                    ...
                    currform.flxDownloadPopup.setVisibility(true);
                
                    currform.btnSTDownload.onClick = function(){
                        scopeObj.contextualActionButtonOnClick(btnId1);
                        currform.flxDownloadPopup.setVisibility(false);
                    };
                    currform.btnSTCancel.onClick = function(){
                        currform.flxDownloadPopup.setVisibility(false);
                    };
                };
...
/**
      ...
      if(status === "successful"){
        this.view.lblStatus.text = kony.i18n.getLocalizedString("i18n.Search.Successful");
      } 
      if(status === "pending") {
        this.view.lblStatus.text = kony.i18n.getLocalizedString("i18n.Search.Pending");
      }
    //   scopeObj.view.lblStatus.text= scopeObj.getFieldValue(this.getTransactionTypeValue(scopeObj._fieldStatus),"text");
      ...
      for(var j = 1; j <= 12; j++){
        ...
        switch(title) {
            case "Transfers": title = kony.i18n.getLocalizedString("i18n.ProfileManagement.Transfers");break;
            case "Withdrawal": title = kony.i18n.getLocalizedString("i18n.Transactions.displayWithdrawal");break;
            case "Others": title = kony.i18n.getLocalizedString("kony.mb.cardLess.others");break;
            case "BlockedFund": title = kony.i18n.getLocalizedString("i18n.accounts.blockedFunds");break;
        }   
