define(function () {
  return {
    ...
    setFirstEnabledDate: function (dateParam) { //dateParam : mm/dd/yyyy
      ...
      if (dateParam === undefined || dateParam === "") {
        ...
        if (this.firstEnabledDate === "" || this.firstEnabledDate === undefined) {
          ...
          this.newFirstEnabledDate = this.firstEnabledDate;
        ...
        this.newFirstEnabledDate = new Date(dateSplit[2], parseInt(dateSplit[0]) - 1, dateSplit[1]);
        this.currMonth = this.firstEnabledDate.getMonth();
        //  this.currYear = this.firstEnabledDate.getFullYear();
    ...
    setLastEnabledDate: function (dateParam) { //dateParam : mm/dd/yyyy
      ...
      if (dateParam === undefined) {
        if (this.lastEnabledDate === "" || this.lastEnabledDate === undefined) {
          ...
          this.newLastEnabledDate =new Date(this.firstEnabledDate);
        ...
        this.newLastEnabledDate =new Date(dateSplit[2], parseInt(dateSplit[0]) - 1, dateSplit[1]);
    ...
    setSelectedDate: function (dateParam) {
      ...
      if (this.flag === true){
        this.newFirstEnabledDate = d;
      } else {
        this.newLastEnabledDate = d;
      }
...
//
    ...
    diffDays: function (fromDate, toDate) {
     ...
     onSelectFromDateValue: function() {
        ...
        var fromDate = formatUtil.getFormatedDateString(this.newFirstEnabledDate, formatUtil.getApplicationDateFormat())
    ...
    onSelectToDateValue: function() {
        ...
        var toDate = formatUtil.getFormatedDateString(this.newLastEnabledDate, formatUtil.getApplicationDateFormat());
    ...
    continueAction: function() {
      ...
      var formatUtil = applicationManager.getFormatUtilManager();
      var fromDateValue = formatUtil.getFormatedDateString(this.newFirstEnabledDate, formatUtil.getApplicationDateFormat());
      var toDateValue = formatUtil.getFormatedDateString(this.newLastEnabledDate, formatUtil.getApplicationDateFormat());
