define(['./ParserUtilsManager'],function(ParserUtilsManager) {
  ...
  return {
    ...
    setVisibilityBasedOnContracts: function() {
      ...
      this.view.flxDropDownWrapper.width = "140dp";
      this.view.flxDropdownValues.width = "140dp";
      ...
      try{
        ...
        segmentContractArray.forEach(function(object){
          for(var key in object){
            object["pageCount"]={};
            object["pageCount"]["text"] = kony.application.getCurrentForm().id === 'frmServiceRequests' ? scope.geti18nValueNew(object[key]) : scope.geti18nValue(object[key]);
