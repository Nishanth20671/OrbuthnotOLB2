...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ACHTemplates", "objectService" : "ACH"};
    ...
    ACHTemplates.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ACH", "ACHTemplates", options, metaDataSuccess, metaDataFailure);
    };
