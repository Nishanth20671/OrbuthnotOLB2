...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "TemplateRecords", "objectService" : "ACH"};
    ...
    TemplateRecords.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ACH", "TemplateRecords", options, metaDataSuccess, metaDataFailure);
    };
