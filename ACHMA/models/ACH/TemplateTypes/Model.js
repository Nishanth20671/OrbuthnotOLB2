...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "TemplateTypes", "objectService" : "ACH"};
    ...
    TemplateTypes.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ACH", "TemplateTypes", options, metaDataSuccess, metaDataFailure);
    };
