define({
    ...
    preShow: function() {
       ...
       if(applicationManager.getPresentationFormUtility().getDeviceName()==="iPhone"){
            ...
            this.view.title = kony.i18n.getLocalizedString("kony.mb.BillPay.EditNickName");
          this.view.flxMainContainerNew.top = "-50dp";
        }
      else{
         this.view.flxHeader.isVisible = true;
         this.view.customHeader.lblLocateUs.text = kony.i18n.getLocalizedString("kony.mb.BillPay.EditNickName");
      }
