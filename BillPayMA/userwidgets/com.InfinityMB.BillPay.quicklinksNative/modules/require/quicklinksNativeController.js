        ...
        for(var i = 1; i <= 10; i++) {
          ...
          if(action !== "") {
            ...
            if(flag && self.EntitlementUtils.isEntitled(link[self._accountType].entitlement)) {
              ...
              var tempLink = {
                "text": kony.i18n.getLocalizedString(link[self._accountType].text),
    ...
    setLinks: function() {
      ...
      try {
        ...
        if(typeof (cancelObj) === "object") {
          self.view.lblCancel.text = 
            kony.i18n.getLocalizedString(self._linkCancel.text);
        } else {
          self.view.lblCancel.text = 
            kony.i18n.getLocalizedString(JSON.parse(self._linkCancel).text);
        }
      } catch(err) {
        var errObj = {
    ...
    showAddIPhoneLinks: function() {
      ...
      try {
        ...
        var actionCancel = new kony.ui.ActionItem({
          "title": kony.i18n.getLocalizedString("kony.tab.addBen.Cancel"),
