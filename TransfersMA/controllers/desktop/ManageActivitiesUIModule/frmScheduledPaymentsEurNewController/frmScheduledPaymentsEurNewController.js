define(['FormControllerUtility', 'CommonUtilities', 'ViewConstants', 'OLBConstants'], function(FormControllerUtility, CommonUtilities, ViewConstants, OLBConstants) {
    ...
    preShow: function () {
      ...
      scope.view.customheadernew.btnSkipNav.onClick = function() {
        scope.view.btnSkipRight.setFocus(true);
      };
    },
    postShow: function () {
    ...
    initActions: function () {
      var scopeObj = this;
      this.view.flxNewPayment.onClick = function () { scopeObj.Europresenter.showTransferScreen({ context: "MakePayment" }) };
      this.view.flxPaymentActivities.onClick = function () { scopeObj.ManageActivitiesPresenter.showTransferScreen({ context: "" }) };
      this.view.flxManageBeneficiaries.onClick = function () { scopeObj.ManageActivitiesPresenter.showTransferScreen({ context: "ManageBeneficiaries" }) };
    },
