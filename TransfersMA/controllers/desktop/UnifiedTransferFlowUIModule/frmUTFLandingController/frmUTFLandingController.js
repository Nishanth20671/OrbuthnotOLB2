  ...
  return {
    ...
    preShow: function () {
      ...
      this.view.UnifiedTransferSelection1.setAccessibility({
        "btnAction1": "Make Same Bank Transfer",
        "btnAction2": "Add Same Bank Account"
      });
      this.view.UnifiedTransferSelection2.setAccessibility({
          "btnAction1": "Make Domestic Transfer",
          "btnAction2": "Add Domestic Account"
        });
      this.view.UnifiedTransferSelection3.setAccessibility({
        "btnAction1": "Make International Transfer",
        "btnAction2": "Add International Account"
      });
      this.view.UnifiedTransferSelection4.setAccessibility({
        "btnAction1": "Pay a Person Transfer",
        "btnAction2": "Add Pay a Person Account"
      });
      this.view.UnifiedTransferSelectionP2P.setAccessibility({
        "btnAction1": " Activate Person-to-Person",
        "btnAction2": "Add P2P Account"
      });
      this.view.CustomPopup.onKeyPress = this.onKeyPressCallBack;
      this.view.onKeyPress = this.onKeyPressCallBack;
      this.view.customheadernew.btnSkipNav.onClick = this.view.UnifiedTransferSelection1.setRichTextFocus.bind(this,this.view.UnifiedTransferSelection1.rtxtId);
    },
    postShow: function () {
