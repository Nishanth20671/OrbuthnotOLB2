    ...
    return {
        ...
        segFromAccountRowClick: function() {
            ...
            if (isOwnAccountsFlow) {
                let filteredAccounts = fromAccounts.filter(function(account) {
                    return CommonUtilities.substituteforIncludeMethod(account.nickName.toLowerCase(), toAccountSearchTerm) || CommonUtilities.substituteforIncludeMethod(account.accountID, toAccountSearchTerm)
                })
        ...
        selectToAccount: function(selectedAccount) {
            ...
            this.view.flxTo.accessibilityConfig = {
                a11yARIA: {
                    "tabindex": 0,
                    "aria-labelledby": "lblSelectAccountTo",
                }
            };
        ...
        setAccessibility: function() {
          this.view.lbxCurrency.accessibilityConfig = {
            ...
            this.view.imgToIcon.accessibilityConfig = {
                a11yARIA: {
                    "tabindex": -1,
                }
            };
            ...
            this.view.flxToIcon.accessibilityConfig = {
                a11yHidden: true,
                a11yARIA: {
                    "tabindex": -1,
                }
