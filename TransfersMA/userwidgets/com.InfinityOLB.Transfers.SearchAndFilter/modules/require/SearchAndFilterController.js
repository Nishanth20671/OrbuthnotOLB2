  ...
  return {
    ...
    preShow: function() {
      try {
        ...
        document.addEventListener('keydown', function(event) {
          if (event.which === 27) {
            scope.view.flxSegmentFilter.setVisibility(false);
    ...
    onSegFilterRowClick: function (triggerEvent, widgetInfo, segInfo) {
      try {
        ...
        this.view.lblSelectedFilterValue.accessibilityConfig = {
          "a11yHidden": true,
          "a11yLabel": this.view.lblView.text + this.view.lblSelectedFilterValue.text,
          "a11yARIA": {
            "tabindex": -1
          }
        }
        this.view.flxSegmentFilter.setVisibility(false);
        if(this.view.flxSegmentFilter.isVisible === false) {
          this.view.flxFilter.accessibilityConfig = {
            "a11yARIA": {
              "tabindex": 0,
              "role":"button",
    ...
    setAccessibility: function() {
      this.view.flxSearchBtn.accessibilityConfig = {
        ...
        this.view.lblSelectedFilterValue.accessibilityConfig = {        
        "a11yLabel": this.view.lblView.text + this.getProcessedText(JSON.parse(this._selectedFilter)["text"]),
        "a11yARIA":{
          "tabindex":-1
        }
      },
