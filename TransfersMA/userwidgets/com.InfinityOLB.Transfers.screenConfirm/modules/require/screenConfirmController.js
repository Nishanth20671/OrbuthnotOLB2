    ...
    sortAccessibility: function () {
      ...
      if (scopeObj.view.imgSortColumn1.src === scopeObj._iconColumnSortAsc) {
        scopeObj.view.flxColumn1.accessibilityConfig = {
          "a11yLabel": "Sort by recent contracts",
          "a11yARIA": {
            role: "button",
            "aria-sort": "ascending"
          }
        ...
        scopeObj.view.flxColumn1.accessibilityConfig = {
          "a11yLabel": "Sort by oldest contracts",
          "a11yARIA": {
            role : "button",
      ...
      if (scopeObj.view.imgSortColumn2.src === scopeObj._iconColumnSortAsc) {
        scopeObj.view.flxColumn2.accessibilityConfig = {
          "a11yLabel": "Sort by lowest identity number",
          "a11yARIA": {
            role: "button",
            "aria-sort": "ascending"
          }
        ...
        scopeObj.view.flxColumn2.accessibilityConfig = {
          "a11yLabel": "Sort by highest identity number",
          "a11yARIA": {
            role: "button",
            "aria-sort": "descending"
          }
        ...
        scopeObj.view.flxColumn2.accessibilityConfig = {
          "a11yLabel": "Sort by identity number",
          "a11yARIA": {
            role: "button"
          }
        }
