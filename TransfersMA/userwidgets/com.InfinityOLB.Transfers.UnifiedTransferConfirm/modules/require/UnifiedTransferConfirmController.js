define(['./UnifiedTransferConfirmBusinessController', './UnifiedTransferConfirmStore'], function (BusinessController, UnifiedTransferConfirmStore) {
  return {
    ...
    */
    preShow: function () {
      var scope = this;
	  this.view.btnAction3.toolTip = kony.i18n.getLocalizedString("i18n.common.confirm");
      this.view.btnAction2.toolTip = kony.i18n.getLocalizedString("i18n.common.modifiy");
      this.view.btnAction1.toolTip = kony.i18n.getLocalizedString("i18n.TransfersEur.btnCancel");
      try {
