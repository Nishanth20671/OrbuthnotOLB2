define(['./UnifiedTransferStore', './UnifiedTransferBusinessController', 'DataValidationFramework/DataValidationHandler'], function (UnifiedTransferStore, BusinessController, DataValidationHandler) {
  ...
  */
    ...
    */
    render: function () {
      ...
      try {
        ...
        if (scope.view.segToAccounts.data.length != 0 && (scope.transferFlow2 === "Repeat" || scope.transferFlow2 === "Edit" || scope.transferFlow2 === "PayBeneficiary")) {
          scope.transferFlow2 = "";
    ...
    */
    initActions: function () {
      ...
      try {
        ...
        this.view.flxFrequencyDropdown.onClick = this.toggleDropdownVisibility.bind(this, this.view.flxFrequencyDropdown, this.view.flxFrequencyList, this.view.lblFrequencyDropdownIcon, this.view.lblFrequency.id);
        ...
        this.view.flxTransferCurrencyDropdown.onClick = this.toggleDropdownVisibility.bind(this, this.view.flxTransferCurrencyDropdown, this.view.flxTransferCurrencyList, this.view.lblTransferCurrencyDropdownIcon, this.view.lblTransferCurrency.id);
        ...
        this.view.flxFromTextBox.onClick = function () {
          this.toggleAccountsDropdown("From");
          this.filterAccounts("From");
        }.bind(this);
  ...
  setAccessibilityValues: function () {
    ...
    this.view.flxClearFromText.accessibilityConfig = { "a11yLabel": "cancel", a11yARIA: { role: "button" }, };
    ...
    this.view.flxClearToText.accessibilityConfig = { "a11yLabel": "cancel", a11yARIA: { role: "button", }, };
    ...
    this.view.flxPayeeAddressDetailIcon.accessibilityConfig = {
      "a11yLabel": "Beneficiary Address Details",
      a11yARIA: {
        "role": "button",
        "aria-expanded": false,
      },
    ...
    this.view.lbxAddressField6.accessibilityConfig = {
      a11yARIA: {
        ...
        this.view.flxAttachDocumentsIcon.accessibilityConfig = { a11yARIA: { role: "button", "aria-labelledby": "lblSupportingDocuments" }, };  
    ...
    this.view.lblSearchField4.accessibilityConfig = {
      ...
      this.view.tbxFromAccount.accessibilityConfig = {
        a11yARIA: { role: "textbox", "aria-labelledby": "lblFromKey", "aria-required": true, },
      };
      this.view.tbxToAccount.accessibilityConfig = {
        a11yARIA: {
          "aria-required": true,
    ...
    */
      ...
      try {
        ...
        if (scope.context.transferType === "Domestic Transfer") {
          ...
          for (let i = 1; i <= paymentMethod.length; i++) {
            ...
            text1 = this.view["lblPaymentMethod" + i].id;
      ...
      try {
        ...
        if (value) {
          ...
          if (isBicValid) {
            ...
            scope.view.rtxErrorMessage.accessibiltyConfig = {
            a11yLabel: kony.i18n.getLocalizedString("i18n.UnifiedTransfer.InvalidBIC"),
              a11yARIA: {
                role: "alert",
                tabindex: -1
            }
          }
          scope.view.flxErrorMessage.accessibiltyConfig = {
            a11yLabel: kony.i18n.getLocalizedString("i18n.UnifiedTransfer.InvalidBIC"),
              a11yARIA: {
                role: "alert",
                tabindex: -1
      ...
      try {
        ...
        for (var i = 0; i < scope.filesToBeUploaded.length; i++) {
          attachmentsData[i] = {
            ...
            "removeAction": {
              "onClick": scope.showCancelPopup.bind(scope,false)
            }
          };
        }
    ...
    deleteAttachment: function (widgetInfo,segInfo) {
      var scope = this;
      try {
        var sectionIndex=segInfo.sectionIndex;
 ...
 */
    inValidIbanError: function () {
      ...
      this.view.rtxErrorMessage.accessibiltyConfig = {
        a11yLabel: kony.i18n.getLocalizedString("i18n.UnifiedTransfer.InvalidIBANFormatMessage"),
        a11yARIA: {
          role: "alert",
          tabindex: -1
        }
    ...
    isAccountNumbersMatch: function (tbx1Widget, tbx2Widget) {
      ...
      try {
        if (tbx1Widget.text !== "" && tbx2Widget.text !== "") {
          ...
          scope.view.rtxErrorMessage.accessibiltyConfig = {
            a11yLabel: kony.i18n.getLocalizedString("i18n.UnifiedTransfer.AccountNumberMismatchMessage"),
              a11yARIA: {
                role: "alert",
                tabindex: -1
            }
            ...
            if (scope.context.transferType === "Same Bank") {
              ...
              if (isAccountNumberValid) {
                ...
                scope.view.rtxErrorMessage.accessibiltyConfig = {
                  a11yLabel: kony.i18n.getLocalizedString("i18n.UnifiedTransfer.AccountAlreadyExistMessage"),
                    a11yARIA: {
                      role: "alert",
                      tabindex: -1
                  }
              ...
              scope.view.rtxErrorMessage.accessibiltyConfig = {
                a11yLabel: kony.i18n.getLocalizedString("i18n.UnifiedTransfer.InvalidAccountNumberFormatMessage"),
                  a11yARIA: {
                    role: "alert",
                    tabindex: -1
                }
              ...
              var isAccountNumberValid = scope.businessController.isValidAccountNumber(tbx1Widget.text);
              if (!isAccountNumberValid && /^[a-z]/i.test((tbx1Widget.text).charAt(0))) {
    ...
    setBeneficiaryDetailsResponse: function () {
      ...
      try {
        if (!scope.isEmptyNullOrUndefined(scope.collectionObj.Collection["beneficiaryDetails"])) {
          ...
          scope.view.rtxErrorMessage.accessibiltyConfig = {
            a11yLabel: kony.i18n.getLocalizedString("i18n.TransferEur.inValidAccountNumber"),
              a11yARIA: {
                role: "alert",
                tabindex: -1
            }
    ...
    */
          ...
          if (scope.view.flxEndDate.isVisible === true) {
              if (scope.view.calStartDate.formattedDate && scope.view.calEndDate.formattedDate) {
                  ...
                  if (endDate.getTime() === startDate.getTime()) {
                      ...
                      scope.view.rtxErrorMessage.accessibiltyConfig = {
                        a11yLabel: kony.i18n.getLocalizedString("i18n.transfers.errors.sameEndDate"),
                      a11yARIA: {
                        role: "alert",
                        tabindex: -1
                        }
                      ...
                      isdvfValidated = false;
                      scope.view.rtxErrorMessage.accessibiltyConfig = {
                       a11yLabel: kony.i18n.getLocalizedString("i18n.transfers.errors.beforeEndDate"),
                      a11yARIA: {
                      role: "alert",
                       tabindex: -1
                  }
      ...
      var scope = this;
            try {
              ...
              if (transactionObj["frequencyType"] !== "Once" && transactionObj["formattedEndOnDate"] !== "Until I cancel") {
                ...
                if (!scope.view.calStartDate.formattedDate) {
                  this.dateValidate();
                  return;
                }
              }
    ...
    showLookupPopup: function () {
      ...
      try {
        ...
        popupObj.flxLookupPopup.flxLookupTitle.flxLookupClose.btnLookupCloseIcon.setFocus(true);
        scope.view.forceLayout();
      } catch (err) {
        var errorObj = {
          "level": "ComponentController",
