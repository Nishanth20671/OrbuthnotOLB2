      ...
      preShow: function(){
        try{
          ...
          if(this._refreshComponent){	
            ...
            this.view.btnTab1.toolTip = this.getBreakPointTypeBasedValue(JSON.stringify(JSON.parse(this._filterTab1)["title"]));
            this.view.btnTab2.toolTip = this.getBreakPointTypeBasedValue(JSON.stringify(JSON.parse(this._filterTab2)["title"]));
      ...
      setBeneficiaryListDesktop: function(serviceResponse,params){
        ...
        for(var i = 0; i < serviceResponse.length; i++){
          ...
          if(btnActionEntitlement){
            ...
            "toolTip":  this.getBreakPointTypeBasedValue(JSON.stringify(JSON.parse(this._dataGridColumn5Tab1)["text"])),
      ...
      setP2PListDataDesktop: function(serviceResponse,params){
          ...
          for(var i = 0; i < serviceResponse.length; i++){
              ...
              if(btnActionEntitlement){
                record["btnAction"] = {
                  "text": this.getBreakPointTypeBasedValue(JSON.stringify(JSON.parse(this._dataGridColumn5Tab2)["text"])), 
                  "toolTip": this.getBreakPointTypeBasedValue(JSON.stringify(JSON.parse(this._dataGridColumn5Tab2)["text"])),
                  "skin": this.getBreakPointTypeBasedValue(this._sknActionButtons),
                  "onClick": scope.btnActionOnClick.bind(scope, serviceResponse, this._dataGridColumn5Tab2)
                }
              } else{
