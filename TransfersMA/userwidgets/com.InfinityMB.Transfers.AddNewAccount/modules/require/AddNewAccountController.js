  ...
  return {
    ...
    **/
    ...
    setRequiredCodeDefaultText:function(){
      ...
      if(!this.isEmptyNullUndefined(this.getFieldValue(this._rcsOROption))){
        this.view.lblRequiredOr.text = this.getFieldValue(this._rcsOROption);
        this.view.flxRequiredBICor.setVisibility(true);
      }else{
        this.view.flxRequiredBICor.setVisibility(false);
      }
    ...
    setRequiredCodeSkins:function(){
      ...
      this.view.flxRequiredBICor.skin = this.getFieldValue(this._rcsOROptionFlexSkin);
      this.view.lblRequiredOr.skin = this.getFieldValue(this._rcsOROptionLabelSkin);
    ...
    onRequireCodeContinue:function(){
      ...
      if(this.isEmptyNullUndefined(this.inputPool["bankName"])) { 
