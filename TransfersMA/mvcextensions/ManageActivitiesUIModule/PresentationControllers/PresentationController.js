define(['CommonUtilities', 'OLBConstants', 'ViewConstants'], function(CommonUtilities, OLBConstants, ViewConstants) {
     ...
     */
    ManageActivitiesPresentationController.prototype.deleteBeneficiary = function(request) {
        this.showProgressBar();
        applicationManager.getRecipientsManager().deleteABenificiary(request, this.updateDeleteBeneficiarySuccessCallBack.bind(this), this.updateDeleteBeneficiaryErrorCallBack.bind(this));
    };
    /**
     * sucess callback for delete beneficiary
     * @param {object} response success reponse
     */
    ManageActivitiesPresentationController.prototype.updateDeleteBeneficiarySuccessCallBack = function(response) {
        var self = this;
