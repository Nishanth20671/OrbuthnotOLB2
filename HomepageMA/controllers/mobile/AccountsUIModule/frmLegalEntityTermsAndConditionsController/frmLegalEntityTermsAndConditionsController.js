define(['CampaignUtility', 'CommonUtilities'], function (CampaignUtility, CommonUtilities) {
  return {
    ...
    onAcceptOfTermsAndConditions: function () {
      let navManager = applicationManager.getNavigationManager();
      let termsAndConditionsData = navManager.getCustomInfo("frmLegalEntityTermsAndConditions");
      let request = {
      ...
      accountsUIModule.presentationController.updateTermsAndConditions(request);
    },
