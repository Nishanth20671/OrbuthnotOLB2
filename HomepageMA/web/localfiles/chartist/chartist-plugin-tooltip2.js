...
(function(window, document, Chartist) {
    ...
    var publicOptions = {
        ...
        template: '<span class="tooltip-text1">{{xDate}} </span>  </br> <span class="tooltip-text2">{{formattedAmountWithCurrency}}</span></br> <span class="{{percentageClass}}">{{percentage}}</span>',
    ...
    Chartist.plugins.tooltip2 = function(options) {
        ...
        return function tooltip(chart) {
            ...
            function showTooltip(triggerElement) {
                ...
                //IW-3878 -START
				if(meta.formattedAmount.slice(0,1) === "-")
					meta.formattedAmountWithCurrency = meta.formattedAmount.slice(0,1) + meta.currencySymbol +" "+ meta.formattedAmount.slice(1,meta.formattedAmount.length);
				else
					meta.formattedAmountWithCurrency = meta.currencySymbol +" "+ meta.formattedAmount;
				//IW-3878 -END
