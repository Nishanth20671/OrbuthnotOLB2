function drawDataChart(filter, xLabels, data, percentages, chartStyle = null, currencySymbol, formattedAmount = []) {
    ...
    AddInvestmentChart(
        xLabels, xData,
        data, percentages, null, null, chartStyle, currencySymbol, interpolationFunc, formattedAmount);
}
