...
//            this.view.NotficationsAndMessages.flxRightNotifications.left="0%";
                ...
                this.view.CustomPopup1.btnNo.centerX = "30%";
                this.view.CustomPopup1.btnNo.bottom = "80px";
                this.view.CustomPopup1.btnNo.width = "120px";
                this.view.CustomPopup1.btnYes.width = "120px"
             }
...
//             }
        ...
        postShowNotifications: function() {
            ...
            if (kony.application.getCurrentBreakpoint() >= 1366 || orientationHandler.isDesktop) {
                ...
                this.view.CustomPopup1.btnNo.centerX = "63%";
                this.view.CustomPopup1.btnNo.bottom = "20px";
                this.view.CustomPopup1.btnNo.width = "120px";
                this.view.CustomPopup1.btnYes.width = "120px";
            }
        ...
        validateMsg: function() {
            ...
            if ((msgbody===undefined || msgbody === null || msgbody === "")&& !(CommonUtilities.isCSRMode())) {
                ...
                this.view.NotficationsAndMessages.btnSendReply.skin = "sknBtnBlockedSSPFFFFFF15Px";
            } 
            if ((re.test(msgbody)) && !(CommonUtilities.isCSRMode())) {
                FormControllerUtility.disableButton(this.view.NotficationsAndMessages.btnSendReply);
                this.view.NotficationsAndMessages.btnSendReply.setEnabled(false);
                this.view.NotficationsAndMessages.btnSendReply.skin = "sknBtnBlockedSSPFFFFFF15Px";
            }
