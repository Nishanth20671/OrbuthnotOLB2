WealthRiskAnalysisGraph = {

   initializeWidget: function (parentNode, widgetModel) {
        var ele = document.createElement("div");
        var area = '<div id="WealthRiskAnalysisGraph" style = "height:100%;  width:100%;"></div>';
        parentNode.innerHTML = area;
        var data = widgetModel.chartData;
        WealthRiskAnalysisGraph.modelChange(widgetModel, "Refresh", data);
        WealthRiskAnalysisGraph.setDataForWealthRiskAnalysisGraph(widgetModel);
    },
    ...
    */
    ...
    setDataForWealthRiskAnalysisGraph: function (widgetModel) {
      var data = widgetModel.chartData;
      if(Object.keys(data).length !== 0){
		
		$(document).ready(
			document.getElementById('WealthRiskAnalysisGraph') ?
				drawWealthRiskAnalysisGraph.bind(null, data) : null
        );
      }
    }
};