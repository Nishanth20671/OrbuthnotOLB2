define(function() {
  ...
  return {
    ...
    constructor: function(baseConfig, layoutConfig, pspConfig) {
      ...
      this.segheader=[{
        'lblSegment': "Segment",
        'lblCurrentWeightHeader': "Current Weight",
        'lblStrategyWeightHeader': "Strategy Weight"
      }];

      this.dataMapping={
        "imgHealth": "healthStatus",
        "lblSegName": "name",
        "lblCurrentWeight": "currentWeight",
    ...
    setData: function(response){
      ...
      for(var i=0; i<response.Assets.length; i++){
        ...
        this.modifiedResponse.Assets[i].currentWeight =  this.modifiedResponse.Assets[i].currentWeight + "%";
        this.modifiedResponse.Assets[i].healthStatus = this.modifiedResponse.Assets[i].healthStatus ==='0' ? 'success.png' : 'aa_password_error.png';
      }
