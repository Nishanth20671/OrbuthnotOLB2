define(function() {
  function SuitabilityProfileBusinessController(){
  }
  SuitabilityProfileBusinessController.prototype.fetchDetails = function(objServiceName,operationName,objName,criteria,onSuccess,onError) {
  ...
  return SuitabilityProfileBusinessController;
});