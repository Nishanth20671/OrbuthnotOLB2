define(function() {
  function myRecommendedStrategyNewDAO(){
    
  }
  
  myRecommendedStrategyNewDAO.prototype.fetchDetails = function(objServiceName,operationName,objName,criteria,onSuccess,onError) {
    ...
    objSvc.customVerb(operationName, options,
      ...
      var  errorObj =
          {
            "errorInfo" : "Fetch Recommended Strategy list service call failed",
            "errorLevel" : "Fabric",
            "error": error
          };
      onError(errorObj);
  ...
  return myRecommendedStrategyNewDAO;
});