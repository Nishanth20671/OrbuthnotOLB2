define(function () {
  function myStrategyDetailsBusinessController(compViewCtrlScope) {
   this.compViewCtrlScope=compViewCtrlScope;
    this.serviceParameters = {};
   
  }
  
 myStrategyDetailsBusinessController.prototype.fetchDetails = function(objServiceName,operationName,objName,criteria,unicode,onSuccess,onError) {
...
myStrategyDetailsBusinessController.prototype.allocationSuccessCallBack = function(response,unicode){
 applicationManager.getPresentationUtility().dismissLoadingScreen();
 this.compViewCtrlScope.serviceCall(response);
},
  
  myStrategyDetailsBusinessController.prototype.setProperties = function (contextDataToBeStored, serviceParameters, customDataFormat, contextData, rowDataMapping) {
    var scope = this;
    try {
  ...
  myStrategyDetailsBusinessController.prototype.setError = function (errorMsg, method) {
    var errorObj = {
  ...
  return myStrategyDetailsBusinessController;
});