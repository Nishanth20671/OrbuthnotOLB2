define(function () {
  ...
  function investmentConstraintsDAO(){
  ...
  /**
     ...
     */
  investmentConstraintsDAO.prototype.fetchDetails = function(objServiceName,operationName,objName,criteria,onSuccess,onError) {
  ...
  return investmentConstraintsDAO;
});