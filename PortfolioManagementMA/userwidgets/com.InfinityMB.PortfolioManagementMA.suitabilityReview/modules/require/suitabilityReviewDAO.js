define(function() {
  function suitabilityReviewDAO(){
    
  }
  
  suitabilityReviewDAO.prototype.fetchDetails = function(objServiceName,operationName,objName,criteria,onSuccess,onError) {
    ...
    objSvc.customVerb(operationName, options,
      ...
      onError(errorObj);
      kony.print("Failed to fetch Suitability Details:" + JSON.stringify(error));
    });
  };
  return suitabilityReviewDAO;
});