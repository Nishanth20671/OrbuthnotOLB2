define(function() {
  function recommendStrategyDAO(){
  }
  recommendStrategyDAO.prototype.fetchDetails = function(objServiceName,operationName,objName,criteria,onSuccess,onError) {
    ...
    objSvc.customVerb(operationName, options,
      ...
      var  errorObj =
          {
            "errorInfo" : "Fetch Recommended Strategy service call failed",
            "errorLevel" : "Fabric",
            "error": error
          };
      onError(errorObj);
