define(function () {
  ...
  function recommendedInstrumentsDAO(){
  ...
  /**
     ...
     */
  recommendedInstrumentsDAO.prototype.fetchDetails = function(objServiceName,operationName,objName,criteria,onSuccess,onError) {
  ...
  return recommendedInstrumentsDAO;
});