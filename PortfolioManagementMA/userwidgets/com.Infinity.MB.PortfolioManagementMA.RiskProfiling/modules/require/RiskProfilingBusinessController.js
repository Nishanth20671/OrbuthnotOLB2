define(function() {
  function RiskProfilingBusinessController(){
  }
  RiskProfilingBusinessController.prototype.fetchDetails = function(objServiceName,operationName,objName,criteria,onSuccess,onError) {
  ...
  return RiskProfilingBusinessController;
});