define(function() {
  function PortfolioRiskAnalysisBusinessController(){
    
  }
  
  PortfolioRiskAnalysisBusinessController.prototype.fetchDetails = function(objServiceName,operationName,objName,criteria,onSuccess,onError) {
  ...
  return PortfolioRiskAnalysisBusinessController;
});