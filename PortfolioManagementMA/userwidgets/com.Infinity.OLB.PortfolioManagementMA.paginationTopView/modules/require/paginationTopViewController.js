  ...
  return {
    ...
    onKeyPressCallBack: function (eventObject, eventPayload) {
      ...
      if (eventPayload.keyCode === 27) {
        if (self.view.flxDropdownValues.isVisible === true) {
          self.view.flxDropdownValues.isVisible = false;
          self.view.imgDropdownIcon.src = self.Icons.dropdownExpandSkin;
    ...
    setAccessibility: function () {
      ...
      this.view.lblPickList.accessibilityConfig ={
        "a11yARIA":{
          tabindex: -1
        }
      };
      this.view.lblDropdownSelectedValue.accessibilityConfig = {
        "a11yARIA":{
          tabindex: -1
        }
      };
      this.view.flxDropdown.accessibilityConfig = {
        "a11yLabel": this.view.lblPickList.text+ " " + this.view.lblDropdownSelectedValue.text,
        "a11yARIA": {
          "aria-expanded": false,
          role: "button"
        }
      ...
      this.view.flxPaginationLast.accessibilityConfig = {
        ...
        this.view.imgPaginationLast.accessibilityConfig = {
        "a11yARIA": {
          "tabindex": -1
        }
      };
        ...
        this.view.imgPaginationNext.accessibilityConfig = {
        "a11yARIA": {
          "tabindex": -1
        }
      };
      ...
      this.view.flxDropdownValues.accessibilityConfig = {
        "a11yARIA": {
          "tabindex": -1,
          "aria-live": "off"
        }
      };
      this.view.flxMobileDropdownValues.accessibilityConfig = {
        "a11yARIA": {
          "tabindex": -1,
          "aria-live": "off"
        }
      };
      this.view.imgPaginationPrevious.accessibilityConfig = {
        "a11yARIA": {
          "tabindex": -1
        }
      };
      ...
      this.view.imgPaginationFirst.accessibilityConfig = {
        "a11yARIA": {
          "tabindex": -1
        }
      };
    ...
    setVisibilityBasedOnContracts: function() {
      ...
      this.view.flxDropDownWrapper.width = "115dp";
      this.view.flxDropdownValues.width = "115dp";
      if(currentVisibilityState == "Show all"){
        ...
        this.view.flxRecordsPerPage.right = "300dp";
        this.view.flxPaginationWrapper.right = "0dp";
        if (kony.i18n.getCurrentLocale() === "ar_AE") {
          this.view.flxPickList.right = "0dp";
          this.view.flxRecordsPerPage.right = "300dp";
      }
      }
        ...
        if (kony.application.getCurrentBreakpoint() > "640") {
          if (kony.i18n.getCurrentLocale() === "ar_AE") {
            this.view.flxRecordsPerPage.right = "20dp";
            this.view.flxPickList.right = "0dp"
          }
          else {
            this.view.flxRecordsPerPage.right = "20dp";
    ...
    postshow: function(){
      ...
      try
      {
        ...
        this.view.flxPaginationWrapper.left=undefined;
        this.view.flxPaginationWrapper.right=undefined;
        this.setAccessibility();
        this.setVisibilityBasedOnContracts();
      }
      catch(err) {
        ...
        setLayoutForTabletRTL: function(){
          this.view.flxPaginationNext.right = "8dp";
          this.view.flxPaginationNext.left = undefined;
        },
        setLayoutForDesktopRTL: function(){
          this.view.flxPickList.left = "0dp";
        },
        ...
        geti18nValueNew: function(fieldValue){
            let pageNo = fieldValue.match(/^\d+/)[0];
            return kony.i18n.getLocalizedString("i18n.paginationheader." + pageNo + "pages");
        },
    ...
    setComponentText: function(){
      ...
      try
      {
       // i18ntext = this.getParsedValue(this._recordsPerPageLabel, kony.application.getCurrentBreakpoint());
        this.view.lblPickList.text = kony.i18n.getLocalizedString("i18n.serviceRequests.View");
    ...
    /*
     * geti18nValue
     * to extract the translated text from i18n
     */
    
    geti18nValue: function(fieldValue) {
    ...
    updatePaginationBar: function(paginatedRecordsLength , totalRecordsLength){
      ...
      try
      {
        ...
        if(kony.i18n.getCurrentLocale()=== "ar_AE"){
          ...
          this.view.imgPaginationFirst.src = last;
          this.view.imgPaginationLast.src = first;
        }else{
    ...
    initActions: function(){
      ...
      try
      {
        ...
        this.view.flxClose.onTouchEnd=scope.close;//IW-3757 - Bhuvanesh
      }
      catch(err)
      {
        var errorObj =
    ...
    close: function(){
      ...
      try{
          ...
          dropdownSegment=this.view.segPages;
        if(dropdownFlex.isVisible){
          this.view.flxDropDownWrapper.top="10dp";
          dropdownFlex.isVisible = false;
          dropdownSegment.isVisible = false;
          this.view.imgDropdownIcon.src=this.Icons.dropdownExpandSkin;
          this.view.flxDropdown.accessibilityConfig = {
    ...
    toggleSegmentVisibility: function() {
      ...
      try{
        ...
        if(dropdownFlex.isVisible){
          ...
          this.view.flxDropDownWrapper.top="-110dp";
     ...
     */
    pageSelection: function(widgetInfo, segInfo) {
      var scope = this;
      try{
        var dropdownFlex,dropdownSegment;
        if(kony.application.getCurrentBreakpoint() == "640"){
        ...
        this.view.imgDropdownIcon.src=this.Icons.dropdownExpandSkin;
        this.view.lblDropdownSelectedValue.text = dropdownSegment.data[segInfo.rowIndex]["pageCount"]["text"];
        currentPageSize = (parseInt)(dropdownSegment.data[segInfo.rowIndex]["key"]);
        currentPage = 1;				   
      ...
      try{
        ...
        segmentContractArray.forEach(function(object){
          for(var key in object){
            object["pageCount"]={};
            object["pageCount"]["text"] = scope.geti18nValueNew(object[key]);
            object["pageCount"]["skin"] = scope.getDropdownLabelSkin();
            object["pageCount"]["onClick"] = scope.pageSelection;
            object["key"] = key;
          } 
    ...
    getWidgetDataMap: function() {
      var widgetDataMap = {
        "btnPageCount" : "pageCount",
        "selectedKey" : "key",
        "CopyflxPages" : "flxPages"
      };
