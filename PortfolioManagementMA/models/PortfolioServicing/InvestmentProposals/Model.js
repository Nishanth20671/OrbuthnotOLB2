...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "InvestmentProposals", "objectService" : "PortfolioServicing"};
    ...
    function InvestmentProposals(defaultValues) {
        var privateState = {};
        context["field"] = "portfolioId";
        context["metadata"] = (objectMetadata ? objectMetadata["portfolioId"] : null);
    ...
    BaseModel.isParentOf(InvestmentProposals);

    //Create new class level validator object
    BaseModel.Validator.call(InvestmentProposals);

    var registerValidatorBackup = InvestmentProposals.registerValidator;

    InvestmentProposals.registerValidator = function() {
        var propName = arguments[0];
        if(!setterFunctions[propName].changed) {
            var setterBackup = setterFunctions[propName];
            setterFunctions[arguments[0]] = function() {
                if(InvestmentProposals.isValid(this, propName, val)) {
    ...
    //For Operation 'getInvestmentProposal' with service id 'getInvestmentProposal3471'
     InvestmentProposals.getInvestmentProposal = function(params, onCompletion){
        return InvestmentProposals.customVerb('getInvestmentProposal', params, onCompletion);
     };

    //For Operation 'getPastProposal' with service id 'getPastProposal1812'
     InvestmentProposals.getPastProposal = function(params, onCompletion){
        return InvestmentProposals.customVerb('getPastProposal', params, onCompletion);
     };

    //For Operation 'getRiskAnalysisIP' with service id 'getRiskAnalysisIP4949'
     InvestmentProposals.getRiskAnalysisIP = function(params, onCompletion){
        return InvestmentProposals.customVerb('getRiskAnalysisIP', params, onCompletion);
     };

    //For Operation 'getOrderProposal' with service id 'getOrderProposal7772'
     InvestmentProposals.getOrderProposal = function(params, onCompletion){
        return InvestmentProposals.customVerb('getOrderProposal', params, onCompletion);
     };

    //For Operation 'getHealthIfOrderAccepted' with service id 'getHealthIfOrderAccepted6879'
     InvestmentProposals.getHealthIfOrderAccepted = function(params, onCompletion){
        return InvestmentProposals.customVerb('getHealthIfOrderAccepted', params, onCompletion);
     };

    //For Operation 'getConstraintsIP' with service id 'getConstraintsIP1973'
     InvestmentProposals.getConstraintsIP = function(params, onCompletion){
        return InvestmentProposals.customVerb('getConstraintsIP', params, onCompletion);
     };

    //For Operation 'getRecommendedInstrIP' with service id 'getRecommendedInstrIP5101'
     InvestmentProposals.getRecommendedInstrIP = function(params, onCompletion){
        return InvestmentProposals.customVerb('getRecommendedInstrIP', params, onCompletion);
     };

    var relations = [];

    InvestmentProposals.relations = relations;

    InvestmentProposals.prototype.isValid = function() {
        return InvestmentProposals.isValid(this);
    };

    InvestmentProposals.prototype.objModelName = "InvestmentProposals";
     ...
     */
    InvestmentProposals.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("PortfolioServicing", "InvestmentProposals", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    InvestmentProposals.clone = function(objectToClone) {
        var clonedObj = new InvestmentProposals();
