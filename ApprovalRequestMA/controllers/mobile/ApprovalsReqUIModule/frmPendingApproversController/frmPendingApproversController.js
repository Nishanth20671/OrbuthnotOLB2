...
return{
    ...
    try{
      ...
      if(applicationManager.getPresentationFormUtility().getDeviceName()==="iPhone"){
        ...
        if(formFlow==="TransactionDetailsApprovals"){
          this.view.title=kony.i18n.getLocalizedString("i18n.payments.pendingApprovers");
        }else{
          this.view.title=kony.i18n.getLocalizedString("i18n.ApprovalRequests.PendingRequesters");
        }
      }else{
        ...
        if(formFlow==="TransactionDetailsApprovals"){
          this.view.customHeader.lblLocateUs.text=kony.i18n.getLocalizedString("i18n.payments.pendingApprovers");
        }else{
          this.view.customHeader.lblLocateUs.text=kony.i18n.getLocalizedString("i18n.ApprovalRequests.PendingRequesters");
        }
      }
    }catch(e){
  ...
  headerData : function(arrowImg,segData,sectionIndex){
    ...
    var res = {
              ...
              "lblPendingCount": {"text": segData[sectionIndex][0].lblPendingCount.text,left : (kony.i18n.getCurrentLocale() === 'ar_AE') ? "13%" : "47%"},
            ...
            item.map((value,num,itemArray) => {
              ...
              if(value !== 0){
                ...
                combineHeadRow.push({
                  ...
                  "lblPendingCount": {"text": "("+kony.i18n.getLocalizedString("kony.i18n.Common.Any")+" "+value+" "+kony.i18n.getLocalizedString("i18n.Search.Pending")+")",left : (kony.i18n.getCurrentLocale() === 'ar_AE') ? "13%" : "47%"},
                  ...
                  if (kony.i18n.getCurrentLocale() === 'ar_AE') {
                   ob.push({"lblUsername" : {text : pendingApprovers[u].fullName},
                            ...
                            "userName" : pendingApprovers[u].userName,
                             "lblPending" : {text : "Pending",left : "1%"},
                            "flximg" : {left : "86%" },
                              "imgUser" : {src : pendingApprovers[u].userImage || "defaultuserimg.png",left : "6%" },
