define(['ViewConstants'], function(ViewConstants) {
	...
	return {
      ...
      getIntervalHeaderForBulkpayments : function(){
        return this.lowerLimit + " - " + this.upperLimit +" "+kony.i18n.getLocalizedString("i18n.konybb.Common.of")+" "+ this.upperLimit + " " + this.pageHeader;
      },
      ...
      getPaginationtext: function(upperlimit) {
        return this.lowerLimit + " - " + upperlimit +" "+kony.i18n.getLocalizedString("i18n.konybb.Common.of")+" "+ upperlimit + " " + this.pageHeader;
      }
      };
});