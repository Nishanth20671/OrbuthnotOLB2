    ...
    return {
        updateFormUI: function(context) {
            ...
            if (context.data) {
                exData = context.data;
                edit = false;
                this.confirmAddRecipient(context.data, edit, OLBConstants.WireTransferConstants.ACCOUNT_INTERNATIONAL);
            }
            ...
            if (context.editData) {
                edit = true;
                this.confirmAddRecipient(context.editData, edit, OLBConstants.WireTransferConstants.ACCOUNT_INTERNATIONAL);
            }
        ...
        confirmAddRecipient: function(data, edit, type, onCancel, onSave, disableModify) {
            ...
            if (IBANUtils.isCountrySupportsIBAN(data.country)) {
                ...
                this.view.rtxBankDetailsValue2.text = (kony.sdk.isNullOrUndefined(data.IBAN)) ? data.iban : data.IBAN
            } else {
