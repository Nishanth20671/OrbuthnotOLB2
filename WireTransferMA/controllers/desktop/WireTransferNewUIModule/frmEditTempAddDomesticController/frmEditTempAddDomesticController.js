    ...
    return {
        ...
        updateFormUI: function(context) {
            ...
            if (context.Edit) {
                ...
                editData.bulkWireTemplateLineItemID = context.Edit.bulkWireTemplateLineItemID;
        ...
        /**
         * fetch the states according to country which is passed and to navigate to frmEditTempAddInternational form
         * @param {Object[]} frmEditTempAddInternational (form name)       
         */
        ...
        sendRecipientData: function(data) {
            ...
            if (this.view.lblStatus.text === "D") {
                var newData = [];
                newData.push(data);
                wireTransferNewModule.presentationController.UpdateBulkWireTemplateRecipients(this.view.id,newData);
            } else {
                data.templateRecipientCategory = "EXISTINGRECIPIENT";
                wireTransferNewModule.presentationController.addRecipientsManually(data, "addTemplateRecipient");
            }
        },
        /*
         *
        ...
        sendEditRecipientData: function(data, editData) {
            ...
            if (this.view.lblStatus.text === "D") {
                data.bulkWireTemplateLineItemID = editData.bulkWireTemplateLineItemID;
                var newData = [];
                newData.push(data);
                wireTransferNewModule.presentationController.UpdateBulkWireTemplateRecipients(this.view.id,newData);
            } else {
                data.templateRecipientCategory = "EXISTINGRECIPIENT";
                data.bulkWireTemplateLineItemID = editData.bulkWireTemplateLineItemID;
                wireTransferNewModule.presentationController.addRecipientsManually(data, "editRecipient");
            }
            flowStatus = false;
            editData.templateRecipientCategory = "";
            editData.bulkWireTemplateLineItemID = "";
        },
        /**
