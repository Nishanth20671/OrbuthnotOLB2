define(['FormControllerUtility', 'CommonUtilities', 'ViewConstants', 'OLBConstants'], function(FormControllerUtility, CommonUtilities, ViewConstants, OLBConstants) {
    ...
    return {
        updateFormUI: function(context) {
            ...
            if (context.data) {
                exData = context.data;
                this.confirmAddRecipient(context.data, context.modify, OLBConstants.WireTransferConstants.ACCOUNT_DOMESTIC);
            }
        },
        init: function() {
        ...
        confirmAddRecipient: function(data, modify, type, onCancel, onSave, disableModify) {
            ...
            if (type === OLBConstants.WireTransferConstants.ACCOUNT_DOMESTIC) {
                ...
                this.view.rtxBankDetailsValue1.text = data.recipientAccountDetails.routingCode;
            ...
            if (disableModify) {
                ...
                this.view.btnModify.onClick = this.modifyAddRecipient.bind(this, type);
            }
            ...
            if (data.contractsData && data.contractsData.length > 0) {
                this.view.flxContractsComponent.setVisibility(true);
              	...
              	this.view.flxStep2Buttons.top = "0dp";
                this.setContractsData(data.contractsData);
            } else {
                this.view.flxContractsComponent.setVisibility(false);
              	this.view.flxStep2ButtonSeperator.width = "96%";
              	this.view.flxStep2Buttons.top = "20dp";
            }
        },
