define(['FormControllerUtility', 'CommonUtilities', 'ViewConstants', 'OLBConstants', 'IBANUtils'], function(FormControllerUtility, CommonUtilities, ViewConstants, OLBConstants, IBANUtils) {
    ...
    return {
        ...
        updateFormUI: function(context) {
            ...
            if (context.data) {
                exData = context.data;
                this.showInternationalAccountDetailsForm(context.states, context.modify);
            }
        ...
        editRecipientAccountDetails: function(context, modify, onCancel) {
            ...
            exData.payeeId = context.payee.payeeId;;
            ...
            if (!modify) {
                this.view.tbxSwiftCode.text = context.payee.swiftCode;
                this.view.tbxIBANOrIRC.text = (kony.sdk.isNullOrUndefined(context.payee.internationalRoutingCode)) ? context.payee.IBAN : context.payee.internationalRoutingCode;
            ...
            // this.view.btnAddRecipent.onClick = this.addRecipient.bind(this,edit);
            ...
            /*function () {
                 if (this.validateAddRecipientForm()) {
                   var wireTransferNewModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule({"moduleName" : "WireTransferNewUIModule","appName" :"WireTransferMA"});
                     wireTransferNewModule.presentationController.showWireTransferAddInternationalRecipientConfirmScreen(this.getFullRecipientData(),edit)
                 }
             }.bind(this);*/
        ...
        setInitialActions: function() {
            ...
            this.setInternationalAddFormValidationActions();
        },
        /**
         ...
         */
        setInternationalAddFormValidationActions: function() {
         ...
         */
        showInternationalAccountDetailsForm: function(states, modify, onCancel) {
            var OLBConstants = applicationManager.getConfigurationManager().OLBConstants;
            ...
            this.view.tbxSwiftCode.onBeginEditing = function () {
            ...
            if (IBANUtils.isCountrySupportsIBAN(exData.country)) {
                this.showIBANField();
            } else {
                this.showIRCField();
            }
            ...
            //this.view.btnAddRecipent.onClick = this.addRecipient.bind(this,onCancel);
            this.view.btnAddRecipent.onClick = this.getContracts.bind(this, modify, true);
            /*function () {
                  if (this.validateAddRecipientForm()) {
                  var wireTransferNewModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule({"moduleName" : "WireTransferNewUIModule","appName" :"WireTransferMA"});
                    wireTransferNewModule.presentationController.showWireTransferAddInternationalRecipientConfirmScreen(this.getFullRecipientData())
                }
            }.bind(this);*/
        },
        /**
            ...
            if (applicationManager.getUserPreferencesManager().isSingleCustomerProfile === false) {
                if (this.validateAddRecipientForm()) {
                    if (edit === true) {
                        ...
                        this.goToAddRecepientDetails(edit);
                    }
                }
            } else {
                this.verifyAndAdd(edit);
        ...
        restrictSpecialCharacters: function() {
            ...
            scopeObj.view.tbxIBANOrIRC.restrictCharactersSet = specialCharactersSet;
        ...
        showIRCField: function() {
            this.view.lblIBANOrIRC.text = kony.i18n.getLocalizedString("i18n.WireTransfer.internationalRoutingCode");
            this.view.tbxIBANOrIRC.placeholder = kony.i18n.getLocalizedString("i18n.WireTransfers.EnterInternationalRoutingCode");
        },
        /**
        ...
        validateAddRecipientForm: function() {
            ...
            if (isNaN(data.payeeAccountNumber.trim())) {
                ...
                return false;
            } else if (!data.swiftCode.trim().match(/^[A-Z]{6}[A-Z0-9]{2}([A-Z0-9]{3})?$/)) {
                this.view.lblError.text = kony.i18n.getLocalizedString("i18n.TransfersEur.InvalidSwiftCodeMessage")
                this.view.flxError.setVisibility(true);
                this.view.tbxSwiftCode.skin = ViewConstants.SKINS.SKNTXTSSP424242BORDERFF0000OP100RADIUS2PX;
                return false;
            }
            this.hideErrorFlexAddRecipient();
            this.view.tbxSwiftCode.skin = ViewConstants.SKINS.SKNTBXLAT0FFFFFF15PXBORDER727272OPA20;
        ...
        showConfirmScreen: function() {
            var wireTransferNewModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule({"moduleName" : "WireTransferNewUIModule","appName" :"WireTransferMA"});
            wireTransferNewModule.presentationController.showWireTransferAddInternationalRecipientConfirmScreen({
                landingPageView: "addRecipient"
            })
        },
        ...
        goToAddRecepientDetails: function(onCancel) {
            var scopeObj = this;
            ...
            scopeObj.view.btnAddRecepientContinue.onClick = this.verifyAndAdd.bind(this, onCancel);
        ...
        setContractsData: function(contractsData, onCancel) {
            ...
            if (contractsData.contracts.length > 0) {
                if (contractsData.contracts.length == 1 && contractsData.contracts[0].contractCustomers.length == 1) {
                    ...
                    contractsData.action = "INTERNATIONAL_WIRE_TRANSFER_CREATE"
        ...
        getContracts: function(modify, isAddFlow) {
            ...
            if (!modify) {
                if (this.validateAddRecipientForm()) {
                    ...
                    var wireTransferNewModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule({"moduleName" : "WireTransferNewUIModule","appName" :"WireTransferMA"});
                    wireTransferNewModule.presentationController.getContracts("INTERNATIONAL_WIRE_TRANSFER_CREATE", "frmWireTransferAddInternationalAccountStep2");
                }
            } else if (this.cif) {
                this.verifyAndAdd(this.isEdit);
            } else {
