define({
    showSelectedRow: function() {
        ...
        if (data[rowIndex].lblDropdown === "P") {
            ...
            data[rowIndex].flxRecentsWireTransfersMobileSelectedNew.height = "60dp";
            ...
            for (i = 0; i < data.length; i++) {
                if (i == rowIndex) {
                    ...
                    data[i].flxRecentsWireTransfersMobileSelectedNew.height = "470dp";
                    data[i].flxRecentsWireTransfersMobileSelectedNew.skin = "slFboxBGf8f7f8B0";
                    ...
                    data[i].flxRecentsWireTransfersMobileSelectedNew.height = "60dp";
                    data[i].flxRecentsWireTransfersMobileSelectedNew.skin = "sknflxffffffnoborder";
