define({
    showSelectedRow: function() {
        ...
        if (data[rowIndex].lblDropdown === "P") {
            ...
            data[rowIndex].flxRecentTransfersNewSelected.height = "50dp";
            data[rowIndex].flxRecentTransfersNewSelected.skin = "sknflxffffffnoborder";
            ...
            for (i = 0; i < data.length; i++) {
                if (i == rowIndex) {
                    ...
                    data[i].flxRecentTransfersNewSelected.height = "285dp";
                    data[i].flxRecentTransfersNewSelected.skin = "slFboxBGf8f7f8B0";
                    ...
                    data[i].flxRecentTransfersNewSelected.height = "50dp";
                    data[i].flxRecentTransfersNewSelected.skin = "sknflxffffffnoborder";
