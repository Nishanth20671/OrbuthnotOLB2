  ...
  return {
    ...
    _generateQRCode: function(cText = "Temenos QR Code", cWidth = "500", cHeight = "500", cCorrectionLavel = 0, cColorDark = "#000000", cColorLight = "#FFFFFF") {
      ...
      if(this.SCA_DPLINK){
        ...
        approveLink = "https://approve.app.link/activate?name="+this.SCA_DPLINK_NAME+"&qrcode="+cText;
...
//       var cText = this._codeText;
    ...
    getSCADPLINK : function(){
      ...
      if(self.clientProperties){
        if(self.clientProperties && self.clientProperties.SCA_DPLINK && self.clientProperties.SCA_DPLINK.toUpperCase()==="FALSE")
          return false;
        else 
          return true;
      } else {
