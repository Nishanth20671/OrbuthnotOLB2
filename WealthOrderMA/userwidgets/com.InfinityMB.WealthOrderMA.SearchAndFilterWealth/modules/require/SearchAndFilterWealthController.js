define(['./ParseUtilsManager'],function(ParseUtilsManager) {
  ...
  return {
    ...
    preShow: function() {
	  ...
	  this.view.txtSearchBox.onDone=this.searchTextChange.bind(this);
      ...
      this.view.flxSearchBoxHolder.onTouchEnd = this.hideSearch;
     
    },

    hideSearch: function(){    
      this.hideVisibleSearchWatch();     
    },
    ...
    setSearchAndFilterTitle: function() {
      try {
        ...
        if(kony.application.getCurrentForm().id ==="frmWatchlist"){
  			this.view.txtSearchBox.placeholder = this.getProcessedText("Add/Remove Instruments");
       }
