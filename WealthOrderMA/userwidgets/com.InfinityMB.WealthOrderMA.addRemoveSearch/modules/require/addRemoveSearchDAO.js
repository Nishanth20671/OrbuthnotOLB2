define(function() {
  function addRemoveSearchDAO(){
  }
  addRemoveSearchDAO.prototype.fetchDetails = function(objServiceName,operationName,objName,criteria,onSuccess,onError) {
    ...
    objSvc.customVerb(operationName, options,
      ...
      var  errorObj =
          {
            "errorInfo" : "Fetch SearchFavoriteInstruments list service call failed",
            "errorLevel": "Fabric",
            "error"     : error
          };
      onError(errorObj);
