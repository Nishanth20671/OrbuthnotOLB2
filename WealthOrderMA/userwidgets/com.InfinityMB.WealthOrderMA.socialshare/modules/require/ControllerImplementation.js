define(function() {
  var konyLoggerModule = require('com/InfinityMB/WealthOrderMA/socialshare/konyLogger');
  var konymp = konymp || {};
        ...
        this.getNativeController = function() {
            try {
                ...
                if (this.nativeControllerInstance === undefined) {
                    ...
                    var nativeControllerPath = 'com/InfinityMB/WealthOrderMA/' + 'socialshare' + '/NativeController' + platformName + '.js';
