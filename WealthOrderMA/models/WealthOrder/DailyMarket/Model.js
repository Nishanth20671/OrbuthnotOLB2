...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "DailyMarket", "objectService" : "WealthOrder"};
    ...
    DailyMarket.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("WealthOrder", "DailyMarket", options, metaDataSuccess, metaDataFailure);
    };
