...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "PortfolioDetails", "objectService" : "WealthOrder"};
    ...
    PortfolioDetails.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("WealthOrder", "PortfolioDetails", options, metaDataSuccess, metaDataFailure);
    };
