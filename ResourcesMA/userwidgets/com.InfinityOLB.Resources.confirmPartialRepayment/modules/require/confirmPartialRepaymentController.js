define(['./formTemplate12Store', './formTemplate12BusinessController', 'ComponentUtility'], function (formTemplateStore, BusinessController, ComponentUtility) {
  ...
  return {
    ...
    initGettersSetters: function () {
            ...
            defineSetter(this, 'pageTitle', value => {
                ...
                if (this._pageTitle === null || this._pageTitle === undefined || this._pageTitle === "") {
                    ...
                    this.view.flxBreadcrumbs.top="-64dp";
    ...
    preShow : function () {
      var scope = this;
      try {
        this.view.flxGroup.doLayout = this.centerPopupFlex;
    ...
    setPopup : function(logOutContext){
      ...
      this.view.CustomPopup.btnYes.onClick=logOutContext.yesClick;
      ...
      this.view.CustomPopup.btnNo.onClick = logOutContext.noClick;
    ...
    centerPopupFlex: function (popupWidget) {
      ...
      if (kony.os.deviceInfo().screenHeight > popupWidget.info.height) {
        popupWidget.top = kony.os.deviceInfo().screenHeight / 2 - popupWidget.info.height / 2 + "dp";
      } else {
    ...
    timeoutCall : function()
    {
      if (kony.application.getCurrentForm()){
        ...
        componentTimeOut.doLayout = this.centerPopupFlex;
    ...
    hidePopup: function () {
      ...
      if (this.view.CustomPopup.srcWidget!== undefined) {
        this.view.CustomPopup.srcWidget.setFocus(true);
      }
    },
    /**
