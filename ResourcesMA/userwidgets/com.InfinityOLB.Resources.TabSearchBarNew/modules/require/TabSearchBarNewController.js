define(['CommonUtilities'], function(CommonUtilities) {
      ...
      postshow: function(){
		CommonUtilities.setA11yFoucsHandlers(this.view.tbxSearch, this.view.flxBoxSearch, this)
      },
        ...
        invokePreShow : function(){
      	...
      	setOnOptionToggle: function(funDef) {
          this.onOptionToggle = funDef;
        },
