        ...
        },
        {
            isVisible: function () {
                if (applicationManager.getConfigurationManager().isMicroAppPresent("TradeSupplyFinMA")) {
                    return checkAtLeastOneFeaturePresent(["RECEIVABLE_BILLS"]);
                }
                return false;
            },
            ...
            subMenu: {
                children: [{
                    isVisible: function () {
                        return checkAtLeastOnePermission(["RECEIVABLE_BILLS_VIEW"]);
                    },
                    id: "Bills",
                    text: "i18n.payments.bills",
                    onClick: function () {
                        ...
                        isVisible: function() {
                    ...
                    },
                           {
                             ...
                             isVisible : function() 
                             {
                               ...
                               //                                  return presentationUtility.MFA && presentationUtility.MFA.isSCAEnabled && presentationUtility.MFA.isSCAEnabled();
                               //                                }
                               //                                else
                               //                                  return false;
                               return true;
