define(['CommonUtilities','FormControllerUtility'], function(CommonUtilities,FormControllerUtility) {
    ...
    return {
        ...
        postShow: function() {
            ...
            if (kony.i18n.getCurrentLocale() === "ar_AE" && kony.application.getCurrentBreakpoint() >= "1366") {
              this.view.btnModify.right = "4%";
            }
            this.view.flxEditGroupDetails.formActionsNew.btnNext.text = kony.i18n.getLocalizedString("i18n.bulkwires.saveupdate");
        },
        preShow: function() {
            var scope = this;
            this.view.Search.top = "65dp";
            this.view.flxCancelPopup.isVisible = false;
            this.view.lblDowntimeWarning.text = kony.i18n.getLocalizedString("kony.i18n.approvalMatrix.pleaseSelectuser");
          ...
          this.view.btnCancelVerify.toolTip = kony.i18n.getLocalizedString("i18n.CardManagement.Back");
          this.view.btnModify.toolTip = kony.i18n.getLocalizedString("i18n.transfers.DeleteGroup");
          this.view.lblContractValue.width="75%";
        },
        filterShow: function() {
...
//         },
        ...
        updateFormUI: function(viewModel) {
            if (viewModel) {
              ...
              if (viewModel.updateSignatorySucessFromAddUsers) {
                this.view.flxAckMessage.setVisibility(true);
                this.view.lblSuccessMessage.text = kony.i18n.getLocalizedString("i18n.approval.addUsersAck");
              }
      ...
      deleteSignatoryGroup : function (res){
        ...
        if(status === "true" || status === true) {
          ...
          this.view.PopupHeaderUM.btnYes.left = undefined;
      ...
      filterData : function(){
		...
		getSectionDataForSignatoryGroups : function () {
          var scope = this;
			return ({
				"btnUserName" : {
					"text" : kony.i18n.getLocalizedString("Kony.mb.userdetail.Username")
				},
				"imgUserName" : {
					 "src": "sorting.png"
				},
				"btnUserRole" : {
					"text" : kony.i18n.getLocalizedString("Kony.mb.userdetail.UserRole")
				},
				"imgUserRole" : {
					"src": "sorting.png"
				},
				"btnAddedOn" : {
					"text" : kony.i18n.getLocalizedString("i18n.common.addedOn")
				},
				"imgAddedOn" :{
					"src": "sorting.png"
				},
				"btnApprovalPermission" : {
					"text" : kony.i18n.getLocalizedString("konybb.SignatoryGroup.Approval")
				},
				"imgRequestTypeApprovePending" : {
					"src": "sorting.png"
				},
				"lblSelectAll" : {
					"text" :kony.i18n.getLocalizedString("konybb.SignatoryGroup.SelectDelete"),
      ...
      checkSigGrpStatus: function(response)
      {
        ...
        if(response.status){
          ...
          scope.view.lblErrorMsg.text = kony.i18n.getLocalizedString("i18n.SignatoryMatrix.WrongGroupName");
      ...
      onBreakpointChange: function(width) {
        ...
        btnViewEditOnclick: function() {
          ...
          scope.view.flxEditGroupDetails.lblNewGrouptitle.text = kony.i18n.getLocalizedString("i18n.approvals.groupName");
          this.view.flxEditGroupDetails.lblGroupDescTitle.text = kony.i18n.getLocalizedString("i18n.approvals.groupDesc") + ":";
        ...
        if(this.noOfUsersSelected >0)
        {
        ...
        else 
          {
            //alert("Please select one or more users to perform this action")
             ...
             scope.view.lblDowntimeWarning.text = kony.i18n.getLocalizedString("kony.i18n.approvalMatrix.pleaseSelectuser");
