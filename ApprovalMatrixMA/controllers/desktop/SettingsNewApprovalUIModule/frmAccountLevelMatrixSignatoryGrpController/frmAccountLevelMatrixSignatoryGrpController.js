  ...
  return{
    ...
    preShow: function () {     
      ...
      if (kony.i18n.getCurrentLocale() === "ar_AE") {
        this.view.Search.flxtxtSearchandClearbtn.right = "21dp";
        this.view.Search.flxtxtSearchandClearbtn.left = "2%";
    
        if (kony.os.deviceInfo().deviceWidth === 820) {
            this.view.Search.flxtxtSearchandClearbtn.right = "10dp";
            this.view.Search.flxtxtSearchandClearbtn.left = "3.7%";
        }
    }
    ...
    onBreakpointChange: function (form, width) {
      ...
      if (kony.application.getCurrentBreakpoint() <= 1024) {
        this.view.customfooternew.flxFooterMenu.width = "800dp";
      }
    },
    ...
    setUpDataSectionRowsForAxxountLevel : function(sectionIndex){
      ...
      var appendData={
        ...
        "lblName":{"text":kony.i18n.getLocalizedString("kony.i18n.approvalMatrix.accountNameHeader")},
        "imgName":{"src":"sorting_next.png"},
        "lblView":{"text":kony.i18n.getLocalizedString("kony.18n.approvalMatrix.lblaccountLevel")},
