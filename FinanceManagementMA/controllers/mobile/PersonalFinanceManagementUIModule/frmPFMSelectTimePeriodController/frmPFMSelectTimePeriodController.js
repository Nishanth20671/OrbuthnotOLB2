  ...
  init : function(){
    ...
    onViewChartClick: function() {
        try {
            ...
            if (selectedRowData.lblName === kony.i18n.getLocalizedString("i18n.Transfers.Monthly")) {
                selectedValue = "month";
            } else if (selectedRowData.lblName === kony.i18n.getLocalizedString("i18n.Transfers.Yearly")) {
                selectedValue = "year";
            }
            var navManager = applicationManager.getNavigationManager();
            var selectedData = navManager.getCustomInfo("frmPFMSelectTimePeriod");
